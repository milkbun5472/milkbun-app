...
const files=[...walk(root),...walk('apps/train'),...['view.mjs','scenery.mjs','destinations.mjs','journey.mjs','carriage.glb','preview.mjs','preview.html'].map(f=>'art/train-carriage/'+f)].filter(p=>!p.endsWith('.test.mjs')&&!p.endsWith('README.md')&&!p.endsWith('build.json')).sort();
