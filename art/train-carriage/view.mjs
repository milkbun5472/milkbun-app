...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-2b387d084fe00867';
import {createWindowScenery} from './scenery.mjs?v=fg-2b387d084fe00867';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-2b387d084fe00867',import.meta.url).href);asset=gltf.scene;
