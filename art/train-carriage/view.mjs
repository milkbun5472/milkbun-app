...
<<<<<<< HEAD
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-aeb880fda881a770';
import {createWindowScenery} from './scenery.mjs?v=fg-aeb880fda881a770';
=======
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-aeb880fda881a770';
import {createWindowScenery} from './scenery.mjs?v=fg-aeb880fda881a770';
>>>>>>> milkbun/main
...
<<<<<<< HEAD
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-aeb880fda881a770',import.meta.url).href);asset=gltf.scene;
=======
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-aeb880fda881a770',import.meta.url).href);asset=gltf.scene;
>>>>>>> milkbun/main
