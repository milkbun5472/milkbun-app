...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-d827b61930e4de0b';
import {createWindowScenery} from './scenery.mjs?v=fg-d827b61930e4de0b';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-d827b61930e4de0b',import.meta.url).href);asset=gltf.scene;
