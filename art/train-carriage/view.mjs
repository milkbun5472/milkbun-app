...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-426a48697f4c439b';
import {createWindowScenery} from './scenery.mjs?v=fg-426a48697f4c439b';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-426a48697f4c439b',import.meta.url).href);asset=gltf.scene;
