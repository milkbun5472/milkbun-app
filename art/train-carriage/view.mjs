...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-b3e494053e96d28a';
import {createWindowScenery} from './scenery.mjs?v=fg-b3e494053e96d28a';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-b3e494053e96d28a',import.meta.url).href);asset=gltf.scene;
