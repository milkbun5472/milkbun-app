...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-7721f2e1c45a3b3d';
import {createWindowScenery} from './scenery.mjs?v=fg-7721f2e1c45a3b3d';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-7721f2e1c45a3b3d',import.meta.url).href);asset=gltf.scene;
