...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-abf1f6647933f99c';
import {createWindowScenery} from './scenery.mjs?v=fg-abf1f6647933f99c';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-abf1f6647933f99c',import.meta.url).href);asset=gltf.scene;
