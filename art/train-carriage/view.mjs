...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-dc9ff4745fd4acb8';
import {createWindowScenery} from './scenery.mjs?v=fg-dc9ff4745fd4acb8';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-dc9ff4745fd4acb8',import.meta.url).href);asset=gltf.scene;
