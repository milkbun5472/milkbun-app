...
<<<<<<< HEAD
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-a9d19360c953cb4a';
import {createWindowScenery} from './scenery.mjs?v=fg-a9d19360c953cb4a';
=======
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-a9d19360c953cb4a';
import {createWindowScenery} from './scenery.mjs?v=fg-a9d19360c953cb4a';
>>>>>>> milkbun/main
...
<<<<<<< HEAD
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-a9d19360c953cb4a',import.meta.url).href);asset=gltf.scene;
=======
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-a9d19360c953cb4a',import.meta.url).href);asset=gltf.scene;
>>>>>>> milkbun/main
