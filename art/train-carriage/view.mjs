...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-11bc6ec871a587f0';
import {createWindowScenery} from './scenery.mjs?v=fg-11bc6ec871a587f0';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-11bc6ec871a587f0',import.meta.url).href);asset=gltf.scene;
