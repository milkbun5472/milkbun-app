...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-df14f636232b5769';
import {createWindowScenery} from './scenery.mjs?v=fg-df14f636232b5769';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-df14f636232b5769',import.meta.url).href);asset=gltf.scene;
