...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-5736d962774e29d9';
import {createWindowScenery} from './scenery.mjs?v=fg-5736d962774e29d9';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-5736d962774e29d9',import.meta.url).href);asset=gltf.scene;
