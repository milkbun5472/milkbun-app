...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-bd50d5646d2e1a12';
import {createWindowScenery} from './scenery.mjs?v=fg-bd50d5646d2e1a12';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-bd50d5646d2e1a12',import.meta.url).href);asset=gltf.scene;
