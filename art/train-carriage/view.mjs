...
<<<<<<< HEAD
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-acdcf150406acdc4';
import {createWindowScenery} from './scenery.mjs?v=fg-acdcf150406acdc4';
=======
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-acdcf150406acdc4';
import {createWindowScenery} from './scenery.mjs?v=fg-acdcf150406acdc4';
>>>>>>> milkbun/main
...
<<<<<<< HEAD
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-acdcf150406acdc4',import.meta.url).href);asset=gltf.scene;
=======
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-acdcf150406acdc4',import.meta.url).href);asset=gltf.scene;
>>>>>>> milkbun/main
