...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-acbcc149e90eb9e6';
import {createWindowScenery} from './scenery.mjs?v=fg-acbcc149e90eb9e6';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-acbcc149e90eb9e6',import.meta.url).href);asset=gltf.scene;
