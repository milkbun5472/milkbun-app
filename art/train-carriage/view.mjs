...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-1660d028f6610295';
import {createWindowScenery} from './scenery.mjs?v=fg-1660d028f6610295';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-1660d028f6610295',import.meta.url).href);asset=gltf.scene;
