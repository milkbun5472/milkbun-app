...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-b89ee57384ffe249';
import {createWindowScenery} from './scenery.mjs?v=fg-b89ee57384ffe249';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-b89ee57384ffe249',import.meta.url).href);asset=gltf.scene;
