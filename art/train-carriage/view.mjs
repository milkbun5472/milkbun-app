...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-0385d12de862efb8';
import {createWindowScenery} from './scenery.mjs?v=fg-0385d12de862efb8';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-0385d12de862efb8',import.meta.url).href);asset=gltf.scene;
