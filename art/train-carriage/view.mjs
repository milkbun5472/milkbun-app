...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-dde0d9dadc846f1e';
import {createWindowScenery} from './scenery.mjs?v=fg-dde0d9dadc846f1e';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-dde0d9dadc846f1e',import.meta.url).href);asset=gltf.scene;
