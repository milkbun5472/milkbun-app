...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-ad67a71aa7b8be0b';
import {createWindowScenery} from './scenery.mjs?v=fg-ad67a71aa7b8be0b';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-ad67a71aa7b8be0b',import.meta.url).href);asset=gltf.scene;
