...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-0a8b6fcba0caf3a7';
import {createWindowScenery} from './scenery.mjs?v=fg-0a8b6fcba0caf3a7';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-0a8b6fcba0caf3a7',import.meta.url).href);asset=gltf.scene;
