...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-895de7c5e9b2b027';
import {createWindowScenery} from './scenery.mjs?v=fg-895de7c5e9b2b027';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-895de7c5e9b2b027',import.meta.url).href);asset=gltf.scene;
