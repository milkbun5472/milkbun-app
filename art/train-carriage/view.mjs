...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-f304868a413be294';
import {createWindowScenery} from './scenery.mjs?v=fg-f304868a413be294';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-f304868a413be294',import.meta.url).href);asset=gltf.scene;
