...
<<<<<<< HEAD
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-c84173cc0b728476';
import {createWindowScenery} from './scenery.mjs?v=fg-c84173cc0b728476';
=======
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-c84173cc0b728476';
import {createWindowScenery} from './scenery.mjs?v=fg-c84173cc0b728476';
>>>>>>> milkbun/main
...
<<<<<<< HEAD
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-c84173cc0b728476',import.meta.url).href);asset=gltf.scene;
=======
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-c84173cc0b728476',import.meta.url).href);asset=gltf.scene;
>>>>>>> milkbun/main
