...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-b6dcbc456b2edf7e';
import {createWindowScenery} from './scenery.mjs?v=fg-b6dcbc456b2edf7e';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-b6dcbc456b2edf7e',import.meta.url).href);asset=gltf.scene;
