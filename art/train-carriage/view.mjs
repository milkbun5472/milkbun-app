...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-a103b5fc7f1c1690';
import {createWindowScenery} from './scenery.mjs?v=fg-a103b5fc7f1c1690';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-a103b5fc7f1c1690',import.meta.url).href);asset=gltf.scene;
