...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-e0733c2d8c5a4d4a';
import {createWindowScenery} from './scenery.mjs?v=fg-e0733c2d8c5a4d4a';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-e0733c2d8c5a4d4a',import.meta.url).href);asset=gltf.scene;
