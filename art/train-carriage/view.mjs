...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-da70aec4cf65bb87';
import {createWindowScenery} from './scenery.mjs?v=fg-da70aec4cf65bb87';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-da70aec4cf65bb87',import.meta.url).href);asset=gltf.scene;
