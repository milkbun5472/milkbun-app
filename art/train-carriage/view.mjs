...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-670a3f099ef7602f';
import {createWindowScenery} from './scenery.mjs?v=fg-670a3f099ef7602f';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-670a3f099ef7602f',import.meta.url).href);asset=gltf.scene;
