...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-bb56ad649d70688b';
import {createWindowScenery} from './scenery.mjs?v=fg-bb56ad649d70688b';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-bb56ad649d70688b',import.meta.url).href);asset=gltf.scene;
