...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-0067d556fe1d225e';
import {createWindowScenery} from './scenery.mjs?v=fg-0067d556fe1d225e';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-0067d556fe1d225e',import.meta.url).href);asset=gltf.scene;
