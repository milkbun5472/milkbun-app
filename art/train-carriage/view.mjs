...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-4f889e12f6d059da';
import {createWindowScenery} from './scenery.mjs?v=fg-4f889e12f6d059da';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-4f889e12f6d059da',import.meta.url).href);asset=gltf.scene;
