...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-39153179a6215ec2';
import {createWindowScenery} from './scenery.mjs?v=fg-39153179a6215ec2';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-39153179a6215ec2',import.meta.url).href);asset=gltf.scene;
