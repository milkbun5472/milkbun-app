...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-ab7dd012f17a4221';
import {createWindowScenery} from './scenery.mjs?v=fg-ab7dd012f17a4221';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-ab7dd012f17a4221',import.meta.url).href);asset=gltf.scene;
