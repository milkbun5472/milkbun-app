...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-73c39607d025fcd3';
import {createWindowScenery} from './scenery.mjs?v=fg-73c39607d025fcd3';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-73c39607d025fcd3',import.meta.url).href);asset=gltf.scene;
