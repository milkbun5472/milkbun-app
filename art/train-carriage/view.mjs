...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-203678530265f0fa';
import {createWindowScenery} from './scenery.mjs?v=fg-203678530265f0fa';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-203678530265f0fa',import.meta.url).href);asset=gltf.scene;
