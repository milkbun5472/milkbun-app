...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-7566a21ac84dc6e1';
import {createWindowScenery} from './scenery.mjs?v=fg-7566a21ac84dc6e1';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-7566a21ac84dc6e1',import.meta.url).href);asset=gltf.scene;
