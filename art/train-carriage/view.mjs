...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-7b78ceef55a7c3f7';
import {createWindowScenery} from './scenery.mjs?v=fg-7b78ceef55a7c3f7';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-7b78ceef55a7c3f7',import.meta.url).href);asset=gltf.scene;
