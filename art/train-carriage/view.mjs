...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-e5c8c3ebf8b26e97';
import {createWindowScenery} from './scenery.mjs?v=fg-e5c8c3ebf8b26e97';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-e5c8c3ebf8b26e97',import.meta.url).href);asset=gltf.scene;
