...
<<<<<<< HEAD
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-1fbc3868e9589cf2';
import {createWindowScenery} from './scenery.mjs?v=fg-1fbc3868e9589cf2';
=======
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-1fbc3868e9589cf2';
import {createWindowScenery} from './scenery.mjs?v=fg-1fbc3868e9589cf2';
>>>>>>> milkbun/main
...
<<<<<<< HEAD
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-1fbc3868e9589cf2',import.meta.url).href);asset=gltf.scene;
=======
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-1fbc3868e9589cf2',import.meta.url).href);asset=gltf.scene;
>>>>>>> milkbun/main
