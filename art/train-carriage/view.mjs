...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-7542b1b1703af212';
import {createWindowScenery} from './scenery.mjs?v=fg-7542b1b1703af212';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-7542b1b1703af212',import.meta.url).href);asset=gltf.scene;
