...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-9a661bf4df64382b';
import {createWindowScenery} from './scenery.mjs?v=fg-9a661bf4df64382b';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-9a661bf4df64382b',import.meta.url).href);asset=gltf.scene;
