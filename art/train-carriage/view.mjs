...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-7b17fb62ad6334de';
import {createWindowScenery} from './scenery.mjs?v=fg-7b17fb62ad6334de';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-7b17fb62ad6334de',import.meta.url).href);asset=gltf.scene;
