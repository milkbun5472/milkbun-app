...
<<<<<<< HEAD
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-54adabc5e7346593';
import {createWindowScenery} from './scenery.mjs?v=fg-54adabc5e7346593';
=======
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-54adabc5e7346593';
import {createWindowScenery} from './scenery.mjs?v=fg-54adabc5e7346593';
>>>>>>> milkbun/main
...
<<<<<<< HEAD
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-54adabc5e7346593',import.meta.url).href);asset=gltf.scene;
=======
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-54adabc5e7346593',import.meta.url).href);asset=gltf.scene;
>>>>>>> milkbun/main
