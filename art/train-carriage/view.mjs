...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-a21b0fb534020153';
import {createWindowScenery} from './scenery.mjs?v=fg-a21b0fb534020153';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-a21b0fb534020153',import.meta.url).href);asset=gltf.scene;
