...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-8ad597cb779a8b50';
import {createWindowScenery} from './scenery.mjs?v=fg-8ad597cb779a8b50';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-8ad597cb779a8b50',import.meta.url).href);asset=gltf.scene;
