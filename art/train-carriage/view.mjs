...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-49f90405374c868f';
import {createWindowScenery} from './scenery.mjs?v=fg-49f90405374c868f';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-49f90405374c868f',import.meta.url).href);asset=gltf.scene;
