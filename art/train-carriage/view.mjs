...
<<<<<<< HEAD
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-8dfc0d389637334b';
import {createWindowScenery} from './scenery.mjs?v=fg-8dfc0d389637334b';
=======
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-8dfc0d389637334b';
import {createWindowScenery} from './scenery.mjs?v=fg-8dfc0d389637334b';
>>>>>>> milkbun/main
...
<<<<<<< HEAD
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-8dfc0d389637334b',import.meta.url).href);asset=gltf.scene;
=======
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-8dfc0d389637334b',import.meta.url).href);asset=gltf.scene;
>>>>>>> milkbun/main
