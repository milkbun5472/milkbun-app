...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-e75aadc1c690d6fa';
import {createWindowScenery} from './scenery.mjs?v=fg-e75aadc1c690d6fa';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-e75aadc1c690d6fa',import.meta.url).href);asset=gltf.scene;
