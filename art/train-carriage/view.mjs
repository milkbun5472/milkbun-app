...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-19e1c3ec928cbad3';
import {createWindowScenery} from './scenery.mjs?v=fg-19e1c3ec928cbad3';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-19e1c3ec928cbad3',import.meta.url).href);asset=gltf.scene;
