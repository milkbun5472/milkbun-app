...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-bf985ef5ee5399aa';
import {createWindowScenery} from './scenery.mjs?v=fg-bf985ef5ee5399aa';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-bf985ef5ee5399aa',import.meta.url).href);asset=gltf.scene;
