...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-82659e981fafba6e';
import {createWindowScenery} from './scenery.mjs?v=fg-82659e981fafba6e';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-82659e981fafba6e',import.meta.url).href);asset=gltf.scene;
