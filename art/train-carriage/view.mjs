...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-eca146e8fbb06ec9';
import {createWindowScenery} from './scenery.mjs?v=fg-eca146e8fbb06ec9';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-eca146e8fbb06ec9',import.meta.url).href);asset=gltf.scene;
