...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-7eaaa9dfa3dee45b';
import {createWindowScenery} from './scenery.mjs?v=fg-7eaaa9dfa3dee45b';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-7eaaa9dfa3dee45b',import.meta.url).href);asset=gltf.scene;
