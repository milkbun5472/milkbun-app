...
import {GLTFLoader} from '../../apps/fairy-garden/vendor/GLTFLoader.js?v=fg-072f983e167b0af0';
import {createWindowScenery} from './scenery.mjs?v=fg-072f983e167b0af0';
...
const gltf=await new GLTFLoader().loadAsync(new URL('./carriage.glb?v=fg-072f983e167b0af0',import.meta.url).href);asset=gltf.scene;
