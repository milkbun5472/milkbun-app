...
import {createDestinations,destinationState} from './destinations.mjs?v=fg-0a8b6fcba0caf3a7';
import {journeyAt,visibleJourney,nextJourneyDistance,drawJourney,drawBridge,drawTunnel} from './journey.mjs?v=fg-0a8b6fcba0caf3a7';
import {ROUTES,SEASONS,WEATHERS} from './environment.mjs?v=fg-0a8b6fcba0caf3a7';
