import {createCarriageView} from './view.mjs?v=fg-82659e981fafba6e';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-82659e981fafba6e';
