import {createCarriageView} from './view.mjs?v=fg-df14f636232b5769';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-df14f636232b5769';
