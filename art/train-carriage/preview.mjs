import {createCarriageView} from './view.mjs?v=fg-5736d962774e29d9';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-5736d962774e29d9';
