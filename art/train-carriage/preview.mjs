import {createCarriageView} from './view.mjs?v=fg-e0733c2d8c5a4d4a';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-e0733c2d8c5a4d4a';
