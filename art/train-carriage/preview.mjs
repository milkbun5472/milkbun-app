import {createCarriageView} from './view.mjs?v=fg-b89ee57384ffe249';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-b89ee57384ffe249';
