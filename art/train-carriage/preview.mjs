import {createCarriageView} from './view.mjs?v=fg-49f90405374c868f';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-49f90405374c868f';
