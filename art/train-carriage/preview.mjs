import {createCarriageView} from './view.mjs?v=fg-0a8b6fcba0caf3a7';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-0a8b6fcba0caf3a7';
