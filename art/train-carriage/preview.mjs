import {createCarriageView} from './view.mjs?v=fg-670a3f099ef7602f';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-670a3f099ef7602f';
