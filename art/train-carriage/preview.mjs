import {createCarriageView} from './view.mjs?v=fg-367961cd8d7e618c';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-367961cd8d7e618c';
