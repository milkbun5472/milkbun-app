import {createCarriageView} from './view.mjs?v=fg-19e1c3ec928cbad3';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-19e1c3ec928cbad3';
