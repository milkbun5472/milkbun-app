import {createCarriageView} from './view.mjs?v=fg-7721f2e1c45a3b3d';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-7721f2e1c45a3b3d';
