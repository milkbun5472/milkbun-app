import {createCarriageView} from './view.mjs?v=fg-dde0d9dadc846f1e';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-dde0d9dadc846f1e';
