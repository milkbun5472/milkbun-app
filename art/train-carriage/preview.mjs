import {createCarriageView} from './view.mjs?v=fg-da70aec4cf65bb87';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-da70aec4cf65bb87';
