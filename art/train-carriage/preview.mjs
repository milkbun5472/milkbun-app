import {createCarriageView} from './view.mjs?v=fg-d827b61930e4de0b';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-d827b61930e4de0b';
