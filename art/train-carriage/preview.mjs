import {createCarriageView} from './view.mjs?v=fg-7eaaa9dfa3dee45b';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-7eaaa9dfa3dee45b';
