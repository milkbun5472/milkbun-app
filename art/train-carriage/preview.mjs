import {createCarriageView} from './view.mjs?v=fg-bd50d5646d2e1a12';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-bd50d5646d2e1a12';
