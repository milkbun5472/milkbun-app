import {createCarriageView} from './view.mjs?v=fg-7542b1b1703af212';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-7542b1b1703af212';
