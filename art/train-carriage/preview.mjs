import {createCarriageView} from './view.mjs?v=fg-b6dcbc456b2edf7e';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-b6dcbc456b2edf7e';
