import {createCarriageView} from './view.mjs?v=fg-0067d556fe1d225e';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-0067d556fe1d225e';
