import {createCarriageView} from './view.mjs?v=fg-7566a21ac84dc6e1';
import {createWindowScenery,ROUTES,WEATHERS,SEASONS} from './scenery.mjs?v=fg-7566a21ac84dc6e1';
