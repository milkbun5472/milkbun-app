...
- **C01 学院背心**（衬衫 + 领带 + 针织背心 + 短裤）：`S=.53 SY=1.25 Z0=.15 python3 skin_outfit.py v2/doll-rigged.glb v2/outfits/hunyuan-c01-shell.glb v2/outfits/outfit_c01.glb`。动作图 `c01.png`。已知：侧面走路时袖窿处会露一点点皮肤。
