...
test("桌子只画一次，同族四处共用同一张", () => {
  ...
  // v68.58 起第七处：关系图那一页（TiesWalk）也是档案馆这一族，搬同一张桌子——
  //   它是从关系板上点一张脸掀开的，桌子一换就像掉进了别的 App。
  assert.equal((src.match(/style: DESK\(/g) || []).length, 7,
    "铺到的页数变了：档案馆列表 / 关系板 / 关系图 / 按条看 / 亲属卡（有卡、无卡两态）/ 导卡，共七处");
