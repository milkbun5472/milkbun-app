...
test("凡是【他亲口说的话】都换了站位，凡是推演数据的照旧坐分析师那把椅子", () => {
  ...
  [["instruction: gAsk(card.poolId) + characterText(char, \"\\n扣着他此刻真实的处境和心情写", "扭蛋SR"],
   ...
   ['的身份去论坛随手发一个帖', "论坛发帖"],
   ['身份发一条朋友圈', "朋友圈"],
   // 「贴吧发帖」（手动让 TA 发一条）v73.310 并进了上面那条「论坛发帖」——同一件事只剩一份，站位跟着它走
   ...
   //   那冻的是长相不是站位。
   ['HeartKit.museSpec(char, box', "发呆（本体亲笔）"],
   // ⚠️v63.84 把马甲这三枪从【分析师】挪到了这一边，是【改判】不是漏改：
   //   原来判它「产出的是数据不是话」——可网名和签名不是数据，是他【亲手填的两栏】。
   //   分析师交上来的必然是「关于他的一句提炼」：提炼过头是工牌，加工过头是一句
   //   谁都能挂的漂亮话（她 2026-09-05 连报了三轮）。她给的话是判据：
   //   「如果是他在这种匿名网站，他会怎么写自己的名字和签名」——那就得他自己来填。
   ['你现在在一个匿名树洞 App 上注册一个号', "马甲·第一次填"],
