...
test("群线上补上【用户是谁】——以前群里只有她一个名字", () => {
  ...
  // v66.57：这一段抽成了 gMeBlock（旁观群照给，只是标题换成「他们各自认识的那个人」）
  assert.match(app, /const gMeBlock = \(profile && \(profile\.name \|\| profile\.persona\)\)[\s\S]{0,300}?profile\.persona/, "用户人设要进群线上");
