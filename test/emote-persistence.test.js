...
assert(/cacheHistory: _shape\.histCache, stream: _engineerChat, timeout: 180000/.test(app), "ordinary private chat must get the same three-minute allowance as offline chat");
