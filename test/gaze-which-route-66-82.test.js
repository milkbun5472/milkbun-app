...
test("设置里那一栏的说明要跟上——一层挪了地方，说明没跟上也是漏", () => {
  ...
  assert.match(box, /「Ta 眼里」的建卡和复看、以及【线上线下的各种总结】也走这条/,
    "那一栏写的是「记忆、日程、钱包、便签等机械后台活」——她照着说明指去便宜线路，顺手把「Ta 眼里」和总结也指过去了，而她无从知道");
  assert.match(box, /总结不出来、「Ta 眼里」不更新时，先回来看这一栏/);
});
