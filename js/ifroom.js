...
(function (root) {
  ...
  const IF_SCALE = "【这条「如果」该有多大】\n"
    ...
    + "· 他的形态——不再是人的样子，或换成另一种存在；\n"
    + "· 他所处的时代与身份——生在别的年代，或从这边落到那边；\n"
    + "· 他还记不记得你——记忆缺了一块，或整个人不认得你了；\n"
    + "· 你俩之间那个岔路口换了方向——当初没遇上、遇上了错过了、或者已经分开了。\n"
  ...
  function openPrompt(charName, uName, hint) {
    ...
    return "你要为「" + charName + "」和「" + uName + "」想一条【如果线】，然后把它的开场写出来。\n"
      ...
      + IF_BEAT + "\n\n"
      + "另外给三样：title＝这条线叫什么（八个字以内，别剧透结局）；"
  ...
  const OPEN_SHAPE = "{\"title\":\"这条线叫什么\",\"premise\":\"哪一样不一样了，一句话\",\"bg\":\"背景画面提示词，一句英文\",\"boxes\":[{\"who\":\"留空＝旁白，填名字＝他说的话\",\"text\":\"这一框的内容\"}]}";
  ...
  const api = {
    ...
    IF_SCALE: IF_SCALE, IF_BEAT: IF_BEAT,
