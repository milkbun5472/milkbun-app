...
//（见 施工规则/prompt-no-content-samples.md）。改成只写【判据】。
...
(function (root) {
  ...
  const OLD_DIM = { form: "TA的形态", era: "TA所处的时代", memory: "TA还记不记得你", fork: "你俩那个岔路口" };
  ...
  const IF_SCALE = "【这条「如果」该有多大】\n"
    ...
    + "只有一条——**动完之后TA还是不是TA**。过得了这一关，多离谱都不算过分；"
    + "过不了，多合理都不算数。\n"
    + "⚠️动完之后，【那个人的核心一个字都不许换】：脾气、说话的方式、在意什么、"
    + "对她的那点心思——这些换掉就不是「如果TA怎样」，而是换了个人，那是小剧场的活。\n"
  ...
  const IF_BEAT = "【怎么写这一拍】\n"
    ...
    + "· who 填TA的名字＝TA说出口的话：只写话本身，别把动作塞进引号里。\n"
  ...
  // 模型给的框收口成 [{who,text}]。who 只认【TA的名字】或空——
  ...
  const OPEN_SHAPE = "{\"about\":\"这条线探的是你俩之间的哪一点\",\"title\":\"这条线叫什么\",\"premise\":\"哪一样不一样了，一句话\",\"dim\":\"这条动掉的那一样东西，十字以内\",\"bg\":\"背景画面提示词，一句英文\",\"boxes\":[{\"who\":\"留空＝旁白，填名字＝TA说的话\",\"text\":\"这一框的内容\"}]}";
  const BEAT_SHAPE = "{\"boxes\":[{\"who\":\"留空＝旁白，填名字＝TA说的话\",\"text\":\"这一框的内容\"}]}";
