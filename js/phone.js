...
function AlbumView({ d, char, t, onBack, onRefresh, refreshing }) {
  ...
  const memoryCard = p => h("button", { key: sig(p), onClick: () => setPhoto(p), className: "shrink-0 text-left active:opacity-70", style: { width: "72%", scrollSnapAlign: "start" } },
