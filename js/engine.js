...
所以：当『你长出来的自我』（＝上文那段、已经沉淀成【正式人格档案】的）在【软层】上和原卡旧倾向不一致时，以【现在的你】为准、大方长成新的样子。至于【最近几轮的经历】：它可以让你此刻【当下松动、临时不一样】（今天格外放松、这件事上破例一次），但在它还没沉淀成正式的『长出来的自我』之前，【不算你人格已经永久改变】——别凭最近几轮就把自己当成彻底变了个人。任何时候都绝不许借此改掉你的核心身份、底线，或否认真实发生过的事。（这不违背『贴合角色卡』——要严格贴合的是你的身份、声纹和核心边界，软层的成长本就是这个角色真实、活着的一部分。）`;
...
async function generateOffline(p, ctx, session) {
  ...
  const tailNudge = continueCue + "\n\n〔幕后提醒，绝不出现在正文里：【★场景一致·别乱编物件·最优先】桌上在吃/喝什么、身边有什么东西、身处什么地方，一律以【前文已经写过的】为准——前文只有排骨汤，就只有排骨汤，绝不凭空冒出前文没出现过的具体物件（和牛/菌菇/红酒之类）；记不清具体是什么，就模糊带过（『碗里的汤』『面前的菜』『手边的杯子』），别硬编一个新的具体名字来填。①【比喻限额·最要紧】这一整段【最多出现一次「像/仿佛/如同/像是/宛如」的比喻】，且只在真能让画面更具体时才用；其余一律直白写【字面上实际发生了什么】——绝不给每个动作/眼神/声音都套一个比喻（禁『像从溺水里浮出来』『像被雨水洗过的天空』『像一把冰锥』『像失而复得的珍宝』『眼神像一潭深水』这类），【尤其禁把人比成动物】——『像只大型犬/大型猫科动物/幼兽/小兽/受伤的动物』一律不许，也禁往颈窝/怀里『蹭/蹭了蹭』这个默认亲昵动作；『眸/眸子/瞳仁』一律写『眼睛』，也别给人贴『洞穿一切的清醒』『毫不掩饰的欢喜』『一种沉沉的疲惫』这种抽象情绪结论；②反陈词滥调清单全程生效——尤其禁通用小动作（挑眉/勾唇/垂眸/轻笑/喉结滚动）和空转大词；【★写到亲密/情欲时·八股重灾区，反而更要守死】(a)用词禁令表照常一个都不许冒——前所未有／过度／强烈／剧烈／深深／紧绷／绷紧／死死／指节／骨节／颤抖／齿缝／牙关紧咬／通红／血色上涌全禁；(b)绝不许把身体或意识写成机器——『系统／宕机／死机／程序／指令／防火墙／短路／过载』一整类禁用；(c)别套通用情欲流水线动作（向后弓起／绷成一条直线／死死抓住布料／不受控地颤抖／咬紧下唇把声音堵回去／脸涨得通红／彻底完了／交出了自己／身体背叛了我），全换成只属于这个角色、这一刻的具体反应和话；(d)比喻在这里尤其严，一段最多一个；③这一段的【句式、开头方式、意象、节奏】不许和你上一段雷同——上一段用过的比喻和小动作这段一律换新的，长短句结构也换着来；④" + (wantLong ? "写够上面要求的篇幅，把这段写足写透，别注水凑字、也别偷懒写短" : "宁可短而准，别长而油") + "；" + (cotT ? "⑤cot 字段必填，先想后写。" : "") + "〕";
...
async function generateOfflineGroup(p, ctx, session) {
  ...
  const gTail = gContinueCue + "\n\n〔幕后提醒，绝不出现在正文里：【★场景一致·别乱编物件·最优先】桌上在吃/喝什么、身边有什么东西、身处什么地方，一律以【前文已经写过的】为准——前文只有排骨汤，就只有排骨汤，绝不凭空冒出前文没出现过的具体物件（和牛/菌菇/红酒之类）；每个成员写的东西也要和别人已经写过的对得上；记不清就模糊带过（『碗里的汤』『面前的菜』），别硬编一个新的具体名字。①【比喻限额·最要紧】整段【最多出现一次「像/仿佛/如同/像是/宛如」的比喻】，只在真能让画面更具体时才用；其余一律直白写字面发生了什么——绝不给每个动作/眼神/声音都套比喻（禁『像一把冰锥』『像被雨水洗过的天空』『像失而复得的珍宝』『眼神像一潭深水』这类），【尤其禁把人比成动物】（像只大型犬/猫科动物/幼兽/小兽一律不许），也禁往颈窝/怀里『蹭/蹭了蹭』；『眸/眸子/瞳仁』一律写『眼睛』，别给人贴『洞穿一切的清醒』『毫不掩饰的欢喜』这种抽象情绪结论；②反陈词滥调清单全程生效——禁通用小动作（挑眉/勾唇/垂眸/轻笑/喉结滚动）和空转大词；【★写到亲密/情欲时·八股重灾区，反而更要守死】(a)用词禁令表照常一个不许冒——前所未有／过度／强烈／剧烈／深深／紧绷／绷紧／死死／指节／骨节／颤抖／齿缝／牙关紧咬／通红全禁；(b)绝不许把身体或意识写成机器（系统／宕机／死机／程序／指令／防火墙／短路／过载）；(c)别套通用情欲流水线动作（向后弓起／绷成直线／死死抓住／不受控颤抖／咬紧下唇／脸涨得通红／彻底完了／交出了自己／身体背叛了我），换成只属于这个角色此刻的具体；(d)比喻尤其严，一段最多一个；③各角色声纹别互相同化，这一轮的句式/意象/开头不许和上一轮雷同；④" + (gWantLong ? "写够上面要求的篇幅，把这几个 beat 写足写透，别注水也别偷懒写短" : "宁可短而准，别长而油") + "；" + (cotT ? "⑤cot 字段必填，先想后写。" : "") + (notes.length ? "⑥本轮短期导演提示必须实际落实：" + notes.join("；") + "。" : "") + "〕";
