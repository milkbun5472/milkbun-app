...
"- 文风不套统一模板：活泼的人可以跳脱潦草，沉静的人可以少写，毒舌的人不必忽然温柔端正，累坏的人甚至只写几段碎句。允许不漂亮、不完整、有私心；这才是私人手记。篇幅随本人和当天内容，大约 1~5 段。",
...
"",
"【标题】标题也按角色本人来：可以是英文、中文、日期、一个物件或随手写的短句；不要为了版式强行文艺。titleEn 可填角色会写的英文短题，不适合英文的角色就填简短日期/代号；titleZh 写自然的中文副题。",
"",
...
async function generateDiary(p, ctx, opts = {}) {
  ...
  if (opts.noChatMaterial) parts.push("【今天没有和对方聊天/相处的素材】今天你没怎么和对方聊天——【多半就是今天没见到她、没和她在一起】。所以：【不要编造聊天里发生的对话或事件，不要翻前几天的旧事充数，更不要把今天写成你见了她、和她相处过】。就依据【今天的行程】和此刻的心情，写你【自己一个人的这一天】：做了什么、去了哪、身体与情绪、脑子里闪过什么、有没有惦记她/等她消息。平淡真实即可，不必硬凑戏剧性、也别虚构和谁在一起。");
