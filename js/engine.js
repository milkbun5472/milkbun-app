...
这仍是同一个人物正在经历的连续场景，不是另一种“成人文模式”。保持角色原有的注意方式、声纹、关系习惯与真实边界；亲密不会自动把人物改写得更强势、侵略、熟练或失控。

只承接已经发生的接触和双方明确给出的反馈，再由这个人物作出下一步选择。不要把强度增加自动解释为支配、粗暴或必须继续升级；遇到需要对方同意、回应或选择的节点就停下，不替对方决定，也不把退开、迟疑或拒绝当成欲拒还迎。

亲密互动不需要用固定的生理升级链证明强度。身体反应只写此刻真实发生且有区分度的少量部分；不要因接吻、挑逗或性张力自动补齐呼吸紊乱、肌肉绷紧、发抖、青筋、沙哑、咬牙、失控等成套反应。同一个反应不要换不同身体部位反复证明，已经成立而没有新变化的状态不继续加码。

强度来自双方实际做了什么、节奏与距离怎样改变、谁选择靠近、停下或退让，而不是不断提高生理形容词的等级。保持身体位置与动作的物理连续，但不逐步拆解本可直接完成的接触。

不要由旁白替互动宣布“这不是调情而是挑衅”“理智断线”“彻底失控”等强度结论；让人物接下来的实际选择自然体现。`;
