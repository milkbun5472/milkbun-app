...
// ⚠️她 2026-09-11：「上一秒他还觉得自己在和我打字，下一秒日程变成睡觉了，他就觉得我躺在他身边了」。
//   两个病一起犯：① 日程是【他一个人的】，可他把「睡觉」读成了「我们一起躺下」——
//      日程从来没说过她在哪，她在不在场只由对话和【同处一室】那一层说了算；
//   ② 日程是按钟点切格的，正说着话的人却不会在两句之间就睡着——那一格说的是
//      「接下来往哪儿去」，真要过去得他自己在对话里走一趟。
...
// 开了动描的【线上】那一份（她 2026-09-11：「开了动描他就是会写什么抵在颈窝喘息，
// 但是因为不在线下所以没用线下那一堆压着」）。
...
// 保温杯」——三样都是把他这个人和他此刻在干嘛原样复述了一遍。那不是马甲，是工牌。
...
const ANON_MASK_RULE = `【这一栏不是「给他设计一个马甲」，是他自己在填】
（她 2026-09-05：「应该是如果是他在这种匿名网站，他会怎么写自己的名字和签名，
而不一定要具体的事」）
⚠️前面那几版都在让你【从人设里提炼一句话】——提炼过头就是工牌，加工过头就是
一句谁都能挂的漂亮话。两头都不对，因为这件事根本不是提炼。
现在换个站法：**他本人坐在那儿，注册这个号，要填一个名字和一句签名。他会填什么？**
（下面这些话里的「他」说的就是你自己——这一整份是写给填这张表的人看的。）
· 这件事本身就带着他是谁：一个嫌麻烦的人和一个非要起个好名字的人，交出来的东西
  天差地别——不必靠内容去表明他是谁。
· 所以先问【他填这两栏时是什么态度】：认真挑，还是随手打几个字？想让人多看一眼，
  还是只求没人来烦？会不会故意起个跟真实的自己反着来的？他有多少耐心填完这一栏？
· **不必非得是一件具体的事。** 名字可以什么都不指——一个声音、一个手感、一个他
  懒得解释的词、一串没意义的字符都行。签名也可以只是一句随口的话，甚至空一句废话。
  重要的是【这是他会填的那种东西】，不是【这句话说清了他是谁】。

【马甲是用来不被认出来的】
判据一句话：把这个网名和签名单独摘出来，给一个完全不认识他的人看——猜得到他是谁、
是干哪一行的吗？猜得到就是写坏了，重写。

所以下面这些一样都不许进网名和签名：
· 他的职业、身份、专业名词，以及只有他那一行才会这么说的词
· 他此刻在做什么、最近发生过什么、你在上面读到的那几句对话里的字眼
· 他的口头禅、他名字里的字、他在别处（朋友圈、论坛、聊天）已经用过的称呼
· 把人设复述成一句话——那是简历，不是马甲

网名该从哪儿长出来：他【私下】在意的某一样东西、一个只有他自己觉得好笑的梗、
一句他当着人说不出口的念头。跟他白天干什么无关。
签名是他愿意挂给一屋子陌生人看的一句话，不是自我介绍、不是宣言。

上面那份人设和心情是给你【定语气】用的——决定他此刻会挑一个丧的、狂的、还是
没头没脑的名字。不是给你抄内容用的。
...
所以两条要一起过：
· 一：给一个不认识他的人看，猜不出他是谁、干哪一行的。（防暴露）
· 二：给一个熟悉他的人看，会说「这确实是他会挂的」。换到另一个角色名下就不对劲了。（防谁都行）
只过第一条＝一句谁都能挂的漂亮话；只过第二条＝把工牌挂上去了。

【那怎么两条都过】抓的不是他【是谁】，是他【怎么看事情】：
· 什么事在他眼里根本不值一提，什么小事他能记很久
· 他觉得哪种事好笑，而别人不觉得
· 他嘴硬不肯承认的那一样
· 他反复绕回去的那件事，哪怕他自己都嫌烦
· 他说话的节奏本身——急还是慢、刻薄还是温吞、爱不爱把话说完
这些一个字都不暴露身份，可换个人就立刻不成立了。**语气本身就是他的指纹，
不必靠内容去认领。**

【别标签化】签名不许是【对自己的形容】：把一个性格词换个说法写出来
（说自己冷淡、说自己懒、说自己不好惹），那是贴标签，不是这个人在说话。
判据：这句话是他【说的一句话】，还是【关于他的一句介绍】？是介绍就重写。
...
· 一个数字、一个日期、一个计数
· 一句彻头彻尾的废话，或者干脆是空的
形状比内容重要：先定这一句是【哪一种东西】，再让他这个人的语气长进去。`;
...
const ANON_MASK_BG = `主页背景写的是一张图：他愿意让陌生人看见的一个画面，一句话说清。
⚠️不许写成他此刻所在的地方、他手边的东西、他刚做过的事——那等于把定位挂上去了，
马甲就白戴了。也别去描述他本人。`;
...
const INTIMATE_CHAT_ANTI_CLICHE = `【话题一到床上，最容易整段变成通用黄文】调情、荤话、做那件事的前后，是现成语料最厚的一档：越到这种时候，"这种场面该说什么"越容易替这个人开口，于是他突然消失，剩下一套换谁都能说的骚话。判断依据是你此刻的感受、关系与实际发生的事。
...
· **判据是【他这个人碰上这种事会是什么反应】，不是【他该怎么帮她】。** 上心的人照自己的方式上心，冷淡的、正忙的、觉得这不关自己事的就那样回——嗯一声、说回自己的事、嘲一句，一样是对的。**为了显得体贴而长出人设里没有的那一面，和所有人都说「我帮你看」是同一个病**：一个是所有人一样热，一个是这个人凭空变热。
...
const ACT_MEANING = "如实填写角色此刻真正正在做的事或所处的活动状态；这是角色自己的实时状态卡，必须用第一人称「我」写，禁止用角色名或「他／她／TA」从旁描述。它答的是【我此刻在哪儿、在做什么】，一句话说完就够；神态、语气、和对方之间的那些来回属于正文，写在你说的话那一头，别挪进这一行。当前事实未变且原表述仍准确时，可以原样填写；事实变化时再更新。无需为了交字段换措辞、制造动作";
...
// 他住在哪个世界（她 2026-09-05：「我之前资料丢了重新找回来然后王爷就变成在公寓里了，
// 原来是会在他府里或者去喂马之类的」）。
//
...
⚠️每一段都要给 place：他这会儿人在哪个【大地方】（城／坊市／宅院这一级）。
location 写细的（具体哪间屋子、哪个铺子），place 写粗的——地图上认得出的那一级地名。
两张地图靠 place 把人挪过去，写不出 place 那一段，他就停在原地不动。
按人设和世界书里写的时代、地方、身份来定他一天的场景：他住的地方叫什么、出门去哪儿、
用什么器物、身边是些什么人。
· 人设是古代／架空／异世界的：绝不许出现公寓、通勤、上班打卡、咖啡店、便利店、手机、电脑
  这类现代物件与场所——他起身在自己的宅子里，出门是去自己该去的地方。
· 人设是现代的：也别把他写成古人。
...
// 她要的不是开一场线下走长文，是【不开线下也让他知道你俩此刻面对面】，说话还是一条一句的气泡。
//
...
function samePlacePresence(uName, group) {
  return "【同处一室·此刻真的面对面】" + (group ? "此刻在场的各位和" + uName + "都" : "你和" + uName + "此刻")
    ...
    //   是很具体的一句，模型顺着它就把「他当然听见了」补上了。缺的那半得说出来：
...
function buildBundle(ctx, opts) {
  ...
  // ⚠️「惦记」本身就是内容——他知道有这回事、会数日子，但不知道里面写了什么，
  //   这比让他知道内容有意思得多，也才不破坏这个功能。
...
function buildScenePrompt(char, sceneDesc, opts) {
  ...
  //   字面没错，可【那只手是谁的、那个胸口是谁的】全丢了，看着像他自己搭着自己。
  //   照片是他自己举着手机拍的，所以「我」＝举着手机的那个人（只露出身体一部分），
  //   「她/你」＝画面里的另一个人。这一句不写死的话，模型只能瞎猜。
  const pov = opts.pov && typeof opts.pov === "object" ? opts.pov : null;
  if (pov && (pov.me || pov.other)) {
    // ⚠️她 2026-09-10 连着看了三版：第一版画成他自己搭自己，加了归属之后还是「怪怪的」——
