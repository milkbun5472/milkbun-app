...
function buildScenePrompt(char, sceneDesc, opts) {
  ...
  if (pov && (pov.me || pov.other)) {
    parts.push("【谁拍的·画面里谁是谁】这是 " + (pov.me || "他") + " 自己举着手机拍下来的一张照片（第一人称视角）。"
      + "描述里的「我／自己」指的是**举着手机的这个人**——画面里只会露出他身体的一部分（手、胳膊、胸口、腿），镜头是从他的眼睛往下看的；"
      + (pov.other ? "描述里的「她／你／" + pov.other + "」指的是**另一个人**，那是画面里的对方。" : "")
      + "**两边别弄混**：说「她的手搭在我胸口」，画面就该是【对方的手】压在【举着手机这个人自己的胸口】上，"
      + "镜头从他的视角往下拍，而不是他自己的手搭在自己身上。");
  }
