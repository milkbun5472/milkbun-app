...
'}'
  ...
  const ICON_PACKS = {
    autumn: { name: "秋叶", dir: "img/icons/autumn/", bare: true, keys: ["carry", "cast", "config", "cwallet", "debate", "diary", "dream", "dreamjournal", "fanfic", "forum", "games", "impression", "lore", "loungeapp", "memlib", "messages", "phone", "pomodoro", "read", "rescue", "shop", "study", "stylelab", "tarot", "theater", "ties", "trpg", "vpscodex", "weekly", "yanqiu"] }
  };
