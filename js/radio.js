...
(function (root, factory) {
  ...
  //
  // 三个距离里，远景和生活半径都有料：这片地方、他的生活半径、今天有人打进来说的话。
  // **只有痕迹那一档是空手的**——DISTANCE_RULE 要它写「他真的在这个台上留下过一点东西」，
  // 可 bed 里唯一跟他沾边的那一份还明写着「不是让你写他」。于是它只能凭空编，
  // 编出来的东西跟这片地方没有任何一根线连着，听的人也就不会「诶」一下。
  //
  // 而时间线电台那边满手是料：他在广播里讲过的话、有人打进去说过的话，
  ...
  function traceBedText(bed) {
    ...
    if (!list.length) return "";
    return "\n\n【「他留下的痕迹」那一档能用的料】这几句是别处的广播里真的播出去过的话——"
      + "有的是他自己说的，有的是有人打进去说的：\n"
      ...
      + "\n这几句一条都用不上的时候，就照这个台自己的路数另写一样他可能留下的小东西。";
  }
