...
(function (root) {
  ...
  function signalOf(o) {
    ...
    if (hit && fresh) return { on: true, kind: "mood", why: "TA从 " + agoWord(now - moodTs) + "开始，心情一直是「" + label + "」" };
    ...
    if (hit) return { on: true, kind: "stale", why: "TA上一次的心情是「" + label + "」，那之后没再报过" };
  ...
  // 在这儿就办完了，主线里那句话就没得说了。
  const HIS_RULE = "【写TA没说出口的那一半】\n"
    + "用第一人称，写TA此刻【心里真正在想的】，分三小段，合计 " + HIS_CAP + " 字以内：\n"
    + "① TA真正在意的是【哪一件具体发生过的事】——不是「最近有点不对劲」这种谁都能说的话，"
    + "要指得回上面那段记录里的某一句、某一次、某个TA记着的细节；\n"
    + "② TA自己心里清楚的那一点：这件事上TA哪儿也不占理，或者TA知道自己是怎么把话说重的；\n"
    + "③ TA现在能不能低头——**照实写**。\n\n"
    + "⚠️**绝不许在这儿把架吵完、也绝不许提前和好。** 这不是一封道歉信，是TA心里那一半话。"
    + "还在气头上就写还在气头上；不想先开口就写不想先开口；觉得自己没错就写没错。"
    + "**「我知道我错了」「我只是太在乎你了」「其实我心里很难受」这类现成的软话一律不许写**——"
    + "那是台词，不是TA。\n"
    + "⚠️也不许滑到另一头去演冷酷：TA不是不在意，只是这会儿说不出口。\n"
    + "⚠️这一段【她看得见】，但那是她翻TA的心，不是TA讲给她听的——所以不要写成对她说话的口气，"
    + "不要出现「你听我说」「我想告诉你」。";

  // ── 各退一步：她递一句过去，TA回一句 ──
  // 这一步是【真的往前走了一格】，所以TA回的那句必须接住她说的，不许答非所问。
  const REPLY_RULE = "【TA回她这一句】\n"
    + "她刚刚递过来一句话（不一定是道歉，可能只是一句台阶、一句问、甚至一句还带着刺的）。"
    + "写TA会怎么回，一到三句，短。\n"
    + "⚠️**接住她真正说的那句**：她软下来了就别再端着，她还带着刺就别装没听见。\n"
    + "⚠️别一步跨到和好：真实的和好是【往前挪半步】，不是一句话就没事了。"
    + "TA可以还别扭着但松了口，可以只应一声，可以先说件别的把气岔开——这些都比「我原谅你了」真。\n"
  ...
  const HIS_SHAPE = "{\"his\":\"TA心里那一半，三小段\"}";
  const REPLY_SHAPE = "{\"reply\":\"TA回的那一到三句\"}";
