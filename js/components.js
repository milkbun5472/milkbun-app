    ...
    h("div", { className: "flex flex-col", style: { position: "relative", flex: 1, minHeight: 0, padding: "10px 14px 9px" } },
      ...
      h("div", { className: "flex items-end", style: { gap: 12 } },
        ...
        h("div", { className: "flex-1 min-w-0 self-stretch flex flex-col" },
          ...
          h("div", { className: "line-clamp-2", style: { fontFamily: F_BODY, fontSize: 11.5, lineHeight: 1.25, color: onCover ? dim : inkA(.63), textShadow: shadow, marginTop: 10, whiteSpace: "normal", overflowWrap: "break-word" } },
            sign ? sign.replace(/\s*\n\s*/g, " ") : "点铅笔写一句签名"),
          // 标签不做药丸：一行小字，用「/」隔开
      ...
      h("div", { className: "flex items-baseline", style: { marginTop: 9, paddingTop: 0, gap: 7, paddingRight: 66 } },
