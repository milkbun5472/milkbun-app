...
const A_MOOD_DICTIONARY_VERSION = 5;
const A_MOOD_RULES = Object.freeze([
  ["hurt",/(?:委屈|受伤|失落|难过|伤心|低落|沮丧|心碎|孤独|落寞|心酸|酸涩|惆怅|遗憾|被刺痛|愧疚|憋屈|崩溃)/,{hurt:.18,valence:-.10,warmth:-.04}],
  ["anger",/(?:生气|愤怒|恼火|烦躁|火大|气恼|无语|厌烦|不悦|恼怒|烦闷|羞恼|心烦意乱|没好气|憋屈)/,{anger:.18,arousal:.12,valence:-.08}],
  ["anxiety",/(?:焦虑|害怕|不安|担心|紧张|恐惧|忐忑|慌|动摇|動揺|警惕|戒备|犹豫|局促|心烦意乱|心乱如麻|不知所措|错愕|受宠若惊|崩溃|愧疚)/,{anxiety:.18,arousal:.10,valence:-.06}],
  ["warmth",/(?:温柔|温软|心软|安心|柔软|甜|幸福|感动|暖|亲昵|宠溺|心疼|怜爱|眷恋|爱意|柔和|亲近|关切|想念|心动|挂念|惦记|关心|受宠若惊|被戳中)/,{warmth:.18,valence:.10,anxiety:-.06}],
  ["fatigue",/(?:累|疲惫|困倦|乏力|倦|没精神|精疲力尽|疲倦|倦怠|慵懒|困乏|犯困)/,{fatigue:.18,arousal:-.10,immersion:-.05}],
  ["positive_valence",/(?:松快|轻松|放松|舒畅|愉快|开心|高兴|快乐|满足|满意|欣慰|雀跃|窃喜|欢喜|期待|得意|骄傲|自豪|喜悦|欣喜|畅快|爽利|惬意|好笑|惊喜|有趣|逗乐)/,{valence:.14,warmth:.05,anxiety:-.04}],
  ...
  ["high_arousal",/(?:激动|兴奋|振奋|亢奋|热血|脸红心跳|心痒难耐|燥热|干劲|惊喜|错愕|受宠若惊)/,{arousal:.16,valence:.06}],
  ["playful",/(?:调皮|戏谑|促狭|逗弄|顽皮|玩味|坏笑|淘气|逗乐|嬉皮|打趣|讨饶)/,{valence:.06,arousal:.04,warmth:.04}],
  ...
  ["posture_neutral",/(?:嘴硬|掌控|走神|哭笑不得|不为所动|审视|坦白)/,{}],
  ["calm",/(?:平静|平和|淡定|从容|安定|安宁|安稳|踏实|释然|专注|认真|好奇|若有所思|沉思|克制|谨慎)/,{}],
