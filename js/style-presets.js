...
(function () {
  ...
  const SM_CAMERA = "【镜头不随人物收缩】角色的克制是【台词】的克制,不是【镜头】的克制。TA话少、冷淡、不外露,恰恰意味着叙述要接住更多:说这句话之前先做完的那个动作、停顿的那一下、手上正在做的事、TA注意到却没提起的东西、身体先于话给出的反应。绝不能因为TA是个冷淡的人就把段落缩成「我看着你。」——那不是克制,那是没写;TA不说的部分必须在纸面上有分量。每句台词旁边至少要有一处具体的、看得见的动作或环境细节;但也不许拿华丽形容词和情绪副词充数,要的是具体物件与动作,不是修饰。";
  ...
  const CATS = [
    {
      ...
      mods: [
        { id: "cam_no_shrink", name: "镜头不随人物收缩", hint: "冷淡的人不等于短段落——TA不说的部分要在纸面上有分量", text: SM_CAMERA, builtinIn: ["theater"] },
        { id: "cam_hands", name: "近景在手上", hint: "优先写手正在摆弄的具体物件，而不是脸上的表情", text: "【近景在手上】每一段里至少有一次把镜头落到【手正在做的事】上:拿着什么、怎么拿的、放下时碰到了什么、指腹蹭到的是哪种材质。人物的状态先从手上泄出来,再轮到脸和话。不要连着写两段「TA看着我」「我看着TA」——视线不是动作,手才是。" },
    ...
    },
    {
      ...
      mods: [
        ...
        { id: "lay_no_markdown", name: "不用 markdown", hint: "禁止 *动作* 星号、井号标题、分隔线", text: "【纯散文格式】正文里不许出现任何标记语言:不用星号包动作(*TA笑了*)、不用井号标题、不用分隔线、不用列表符号、不用粗体斜体。动作和心理直接写进句子里,靠语言本身区分,不靠符号。" },
    ...
    },
    {
      ...
      mods: [
        { id: "ac_no_ceo", name: "别滑进霸总腔", hint: "点名禁掉攥手腕/往怀里带/冷笑/挑眉那一整套", text: "【别滑进霸总腔】下面这些是网文霸总的【现成模板】,一律不许用:\n· 动作模板:攥住/扣住手腕、捏下巴抬起脸、往怀里带/揽进怀里、拦在身前、抵在墙上、拇指碾过腕骨或唇角、手指收紧。\n· 表情模板:冷笑、嗤笑、挑眉、勾唇、眯起眼、没什么温度的笑、眼底暗了暗。\n· 句式模板:「TA没说话,只是……」「空气瞬间凝固」「TA的声音低了下来」「不容拒绝地」「不由分说」。\n· 旁白模板:替人物盖章定性(「这个男人向来说一不二」「TA从不解释」)。\n禁的是【模板】,不是强势的人物:TA照样可以强硬、可以动手、可以不讲道理——但要用这个人自己会做的具体动作去写,不许套上面这几张现成的皮。" },
        { id: "ac_no_label", name: "不给情绪贴标签", hint: "写征兆，不写结论", text: "【不给情绪贴标签】不许直接写出情绪的名字(愤怒、失落、慌乱、心疼、委屈、释然…),也不许用「TA感到…」「她意识到…」这种句式把结论端出来。只写征兆:动作变了、说话的速度变了、手上的事停了、注意力跑到别处去了。读者自己会读出来;你一说出名字,那份情绪就死了。" },
        ...
        { id: "ac_metaphor_quota", name: "比喻限量", hint: "一段最多一个，且必须来自这个人真的见过的东西", text: "【比喻限量】一整段最多一个明喻或暗喻,超了就删。用的喻体必须是【这个人物在TA的生活里真的见过的东西】——TA没进过实验室就别用显微镜作比,没见过海就别写像潮水。宁可不打比方,直接把那个东西本身写清楚。" },
    ...
    },
    {
      ...
      mods: [
        ...
        { id: "craft_subtext", name: "台词带潜台词", hint: "人说的从来不是TA真正想说的", text: "【台词带潜台词】人在意的事很少直接说出口。台词优先写成【绕开真正想说的那句】:问一件不相干的小事、挑一个无关紧要的毛病、答非所问、忽然说起别的。真正的意思由这个绕法本身透出来。整场里至多允许一句人物真的把心里话直说,而且要留到值得的位置。" },
        ...
        { id: "craft_time_texture", name: "时间有质感", hint: "等待和间隔要真的被写出来", text: "【时间有质感】等待、沉默和间隔要占真实的篇幅,不许用「过了一会儿」「许久」一笔带过。这几秒里有东西在继续走:锅还在响、雨还在下、TA手上的活没停。让读者跟着一起等完那段时间,而不是被通知时间过去了。" },
    ...
    {
      id: "voice", zh: "声音", hint: "叙述者是谁、TA怎么称呼人",
      mods: [
        { id: "voice_register", name: "称谓锚", hint: "不用「这女人/那家伙/这丫头」这类类型化叫法", text: "【称谓锚】心里想到对方时,用这个人物【自己真的会用】的称呼——名字、小名、或者TA习惯的那个叫法。「这女人」「那女人」「这丫头」「这小东西」「那家伙」这类类型化的叫法一律不许出现,除非人设里写明了TA就是这么叫她的。这一条在内心独白和心声里尤其要守,那正是网文腔最容易钻进来的地方。" },
        { id: "voice_no_narrator", name: "叙述者不评价", hint: "叙述者只呈现，不给人物盖章", text: "【叙述者不评价】叙述的那个声音只负责呈现,不负责评判:不许出现「TA这个人向来…」「她大概是这世上最…」这种替人物盖章的句子,也不许由叙述来夸自己笔下的人好看、厉害、危险。人物是什么样,让TA做的事说明。" }
      ]
    },
    {
  ...
  const TEST_SCENES = [
    { id: "quiet", name: "安静的一场", setting: "深夜的厨房，只开了抽油烟机上那盏灯。TA在洗今天最后一只碗，水声不大。你刚从外面回来，还没换鞋。", user: "我把钥匙丢在台面上，没说话。" },
    { id: "friction", name: "有摩擦的一场", setting: "傍晚的客厅。一件说好了要办的事TA没办，你今天才知道。电视开着但没人在看。", user: "「你什么时候打算告诉我？」" },
    { id: "close", name: "靠得很近的一场", setting: "散场后的车里，还没发动。外面在下小雨，雨刷没开，玻璃上全是水。", user: "我伸手把TA领口那颗歪掉的扣子扶正了。" },
    { id: "walk", name: "在外面走的一场", setting: "冬天的傍晚，你们沿着一条商铺快关门的街往回走，谁都没提刚才那件事。", user: "我走慢了一点，等TA跟上来。" }
  ];
  ...
  // ⭐一次调用写够，别拿多次调用去补（她 2026-08-24：「酒馆用差不多的站子，
  // 一次调用就能生成那么多不被截断，我只要一次调用」）。
  // 翻了她那份 Ako 1.91 预设，配方就三样，我三样都做错了：
  //   ① openai_max_tokens: 65535   —— 它是【天花板】不是预付款，给大了不多花钱，
  //      给小了才要命：思考模型的推理 token 也算在里面，我给 7900，推理吃掉一大半，
  //      剩下的额度只够两百来字。上下文 100w 是输入侧，跟这个无关。
  //   ② content_minimal_words: 1500 / content_max_words: 2000 —— 下限【和上限】一起给。
  //      只给下限，模型没有目标区间，写到哪算哪。
  ...
  async function runTest(active, opts) {
    ...
    const sys = [
      ...
      // 名字放在这儿而不是只写在【输出】里，任何一段提示词都能知道自己是谁
      ...
      wrap(styleText),
      "【输出】用第一人称『我』完全代入「" + (char.name || "TA") + "」，称对方为『你』，对话用引号，写成连续的场景正文。只输出正文，不要 JSON、不要标题、不要任何解释、不要报告字数。",
      wordRule(minW)
    ].filter(x => String(x || "").trim()).join("\n\n");

    let want = tokensFor(minW || 600);
    let text = "";
    const t0 = Date.now();
    try {
      text = String(await callAI(active, sys, [{ role: "user", content: scene.user }], {
        maxTokens: want, stream: canStream, timeout: 300000
      }) || "").trim();
    } catch (e) {
    ...
    if (minW && final < minW) {
      // 就这一次调用，不偷偷补写。写不够就照实说，怎么办由她定。
      notes.push("⚠️模型只写了 " + final + "/" + minW + " 字，就这一次调用没再补。"
        + "再点一次试写多半就够了；老是不够就换个模型，或者把人设写细一点——模型没东西可写时就会早早收尾。");
    }
