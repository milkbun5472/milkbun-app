...
import {DRACOLoader} from '../fairy-garden/vendor/DRACOLoader.js?v=fg-194c9a0f17f7facc';
import * as T from 'three';
import {GLTFLoader} from '../fairy-garden/vendor/GLTFLoader.js?v=fg-194c9a0f17f7facc';
import {createTraveler} from '../fairy-garden/traveler.mjs?v=fg-194c9a0f17f7facc';
import {bubbleRows,bubbleHold,BUBBLE_GAP} from '../fairy-garden/speech.mjs?v=fg-194c9a0f17f7facc';
