...
import {DRACOLoader} from '../fairy-garden/vendor/DRACOLoader.js?v=fg-d6c699fdeba47ce3';
import * as T from 'three';
import {GLTFLoader} from '../fairy-garden/vendor/GLTFLoader.js?v=fg-d6c699fdeba47ce3';
import {createTraveler} from '../fairy-garden/traveler.mjs?v=fg-d6c699fdeba47ce3';
import {bubbleRows,bubbleHold,BUBBLE_GAP} from '../fairy-garden/speech.mjs?v=fg-d6c699fdeba47ce3';
