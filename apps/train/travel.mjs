import '../fairy-garden/rules.js?v=fg-b89ee57384ffe249';
...
export function startTrip(garden=null,random=Math.random,previous=null){
 ...
 return {version:1,map:'carriage',day,minute,epoch:garden?.epoch||'train-'+Math.floor(random()*1e12),distance:0,routeStart:Math.floor(random()*3),trips:(previous?.trips||0)+1};
}
