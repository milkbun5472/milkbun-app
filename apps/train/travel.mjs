import {ROUTES,SEASONS,WEATHERS} from '../../art/train-carriage/environment.mjs?v=fg-aa26ce08d191440c';
import {visibleJourney} from '../../art/train-carriage/journey.mjs?v=fg-aa26ce08d191440c';
import {destinationState} from '../../art/train-carriage/destinations.mjs?v=fg-aa26ce08d191440c';
import '../fairy-garden/rules.js?v=fg-aa26ce08d191440c';
...
export function startTrip(garden=null,random=Math.random,previous=null){
 ...
 return {version:1,map:'carriage',day,minute,epoch:garden?.epoch||'train-'+Math.floor(random()*1e12),distance:0,routeStart:Math.floor(random()*3),trips:(previous?.trips||0)+1,photos:previous?.photos||[],companionPhotos:previous?.companionPhotos||[],artworks:previous?.artworks||[],puzzle:previous?.puzzle||null};
}
