import {restState} from './rest.mjs?v=fg-7eaaa9dfa3dee45b';
import {currentPromise,matchesTheme} from './photo-promise.mjs?v=fg-7eaaa9dfa3dee45b';
import {travelContext,travelEnvironment,ROUTE_LENGTH} from './travel.mjs?v=fg-7eaaa9dfa3dee45b';
import {visibleJourney} from '../../art/train-carriage/journey.mjs?v=fg-7eaaa9dfa3dee45b';
import {cropRect} from './album.mjs?v=fg-7eaaa9dfa3dee45b';
const hash=s=>{let h=2166136261;for(const c of String(s))h=Math.imul(h^c.charCodeAt(0),16777619);return h>>>0;};
import {FILM_LIMIT,WAITING_FILM_LIMIT} from './photo-limits.mjs?v=fg-7eaaa9dfa3dee45b';
export {FILM_LIMIT};
