import {restState} from './rest.mjs?v=fg-dde0d9dadc846f1e';
import {currentPromise,matchesTheme} from './photo-promise.mjs?v=fg-dde0d9dadc846f1e';
import {travelContext,travelEnvironment,ROUTE_LENGTH} from './travel.mjs?v=fg-dde0d9dadc846f1e';
import {visibleJourney} from '../../art/train-carriage/journey.mjs?v=fg-dde0d9dadc846f1e';
import {cropRect} from './album.mjs?v=fg-dde0d9dadc846f1e';
const hash=s=>{let h=2166136261;for(const c of String(s))h=Math.imul(h^c.charCodeAt(0),16777619);return h>>>0;};
import {FILM_LIMIT,WAITING_FILM_LIMIT} from './photo-limits.mjs?v=fg-dde0d9dadc846f1e';
export {FILM_LIMIT};
