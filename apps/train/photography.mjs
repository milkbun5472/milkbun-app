...
import {currentPromise,matchesTheme} from './photo-promise.mjs?v=fg-bf985ef5ee5399aa';
import {travelContext,travelEnvironment,ROUTE_LENGTH} from './travel.mjs?v=fg-bf985ef5ee5399aa';
import {visibleJourney} from '../../art/train-carriage/journey.mjs?v=fg-bf985ef5ee5399aa';
import {cropRect} from './album.mjs?v=fg-bf985ef5ee5399aa';
const hash=s=>{let h=2166136261;for(const c of String(s))h=Math.imul(h^c.charCodeAt(0),16777619);return h>>>0;};
import {FILM_LIMIT,WAITING_FILM_LIMIT} from './photo-limits.mjs?v=fg-bf985ef5ee5399aa';
export {FILM_LIMIT};
