...
(function(root){
 ...
 home:{name:'自己的小屋',interior:true,asset:'./home-interior.glb?v=fg-1da92177083eb3ef',renderer:'glb',background:'#d9cbbb',light:2.1,radius:4.2,bounds:{w:5.6,d:5.6},floor:.14,view:{x:0,z:0},spawn:{x:0,z:2.35},exits:{travel:{to:'garden',at:{x:-5.4,z:3.55}}},stations:{travel:{x:0,z:2.55},rest:{x:-.65,z:.15}},interactions:[{kind:'travel',x:0,z:2.7,r:.55}],obstacles:[{x:-1.8,z:-1.55,w:1.5,d:2.4},{x:1.98,z:-1.65,w:1.5,d:.9},{x:1.9,z:-.73,r:.3},{x:.1,z:-2.6,w:1.6,d:.6},{x:-2.66,z:1.03,w:.55,d:1.6}]},
