...
(function(root){
 ...
 interactions:[{kind:'board',x:-1.6,z:-2.1,r:.5},{kind:'visit',id:'bridge',x:10,z:3.05,r:.5},{kind:'visit',id:'square',x:-1,z:-.65,r:.5},{kind:'visit',id:'market',x:-.7,z:1.25,r:.4},{kind:'well',x:-2.7,z:2,r:.75},{kind:'garden',x:-7.6,z:.2,w:1.9,d:2.1},{kind:'brew',x:-3.6,z:3,r:.5},{kind:'travel',x:10,z:-1,r:.6},{kind:'star',x:-5.8,z:3.95,r:.4},...Object.entries({home:[-5.4,3.1],hall:[-1,-2.2],neighbor1:[-8,-2.7],neighbor2:[-6,-5.8],neighbor3:[6,-4.8],pond:[4,5.1]}).map(([id,[x,z]])=>({kind:'visit',id,x,z,r:.5}))],
 ...
 home:{name:'自己的小屋',interior:true,asset:'./home-interior.glb?v=fg-b99ea897b9e17f80',renderer:'glb',background:'#d9cbbb',light:2.1,radius:4.2,bounds:{w:5.6,d:5.6},floor:.14,view:{x:0,z:0},spawn:{x:0,z:2.35},exits:{travel:{to:'garden',at:{x:-5.4,z:3.55}}},stations:{travel:{x:0,z:2.55},rest:{x:-.65,z:.15}},interactions:[{kind:'travel',x:0,z:2.7,r:.55}],obstacles:[{x:-1.8,z:-1.55,w:1.5,d:2.4},{x:1.98,z:-1.65,w:1.5,d:.9},{x:1.9,z:-.73,r:.3},{x:.1,z:-2.6,w:1.6,d:.6},{x:-2.66,z:1.03,w:.55,d:1.6}]},
