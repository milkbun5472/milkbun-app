...
(function(root){
 ...
 museum:{name:'拾光收藏馆',interior:true,renderer:'museum',decorAssets:['./museum-interior.glb?v=fg-50da860d0b7681fe'],background:'#d5cdbb',light:2.2,radius:7,viewSpan:14.8,bounds:{w:9.5,d:7.5},floor:.14,view:{x:0,z:0},spawn:{x:0,z:3.2},plan:{w:10,d:8},displays:MUSEUM_DISPLAYS,
 ...
 hall:{name:'炉光公共厅',interior:true,asset:'./public-hall.glb?v=fg-50da860d0b7681fe',renderer:'glb',background:'#d7c8b5',light:2.1,radius:9,viewSpan:18,bounds:{w:13.5,d:8.5},floor:.14,view:{x:0,z:0},spawn:{x:0,z:3.85},plan:{w:14,d:9},furniture:HALL_FURNITURE,
 ...
 dormitory:{name:'公共厅楼上',interior:true,asset:'./hall-dormitory.glb?v=fg-50da860d0b7681fe',renderer:'glb',background:'#d6cbbb',light:2,radius:9,viewSpan:18,bounds:{w:13.5,d:8.5},floor:.14,view:{x:0,z:0},spawn:{x:5.7,z:3.3},plan:{w:14,d:9},rooms:DORM_ROOMS,walls:DORM_WALLS,
 ...
 garden.asset='./village-ground.glb?v=fg-50da860d0b7681fe';garden.decorAssets=[];
 ...
 const districtAssets=['./village-home.glb?v=fg-50da860d0b7681fe','./village-hall.glb?v=fg-50da860d0b7681fe','./village-neighbor1.glb?v=fg-50da860d0b7681fe','./village-neighbor2.glb?v=fg-50da860d0b7681fe','./village-neighbor3.glb?v=fg-50da860d0b7681fe','./village-pond.glb?v=fg-50da860d0b7681fe','./village-museum.glb?v=fg-50da860d0b7681fe'];
 ...
 garden.chunks.push({id:'lake-far',x:18,z:-2,radius:12,asset:'./village-lake-far.glb?v=fg-50da860d0b7681fe'});
