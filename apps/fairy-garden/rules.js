...
(function(root){
 ...
 obstacles:[MUSEUM_EXTERIOR,{x:11,z:3,w:7.6,d:1.6,except:{x:10,z:3,w:1.55,d:2.5}},{id:"legacy-market-a",x:-.7,z:2.1,w:1.25,d:.55},{id:"legacy-market-b",x:-2.3,z:1.45,w:1.25,d:.55},{x:-2.4,z:-1.6,w:1.25,d:.28},{x:-5,z:1.6,w:3.5,d:2.9},{x:-1,z:-5,w:6.8,d:4.5},{x:6,z:-6,w:3.15,d:2.55},{x:-6,z:-7,w:2.6,d:2.2},{x:-8,z:-4,w:3.15,d:2.55},{x:5,z:-11,r:1},{x:-2.7,z:2,r:.72},{x:-3.6,z:3,r:.42},{id:'flowerbed-south',x:-7.6,z:.8,w:1.85,d:1.0},{id:'flowerbed-north',x:-7.6,z:-.4,w:1.85,d:1}, {x:4,z:3,rx:4.0,rz:3.35,except:{x:4,z:5.8,w:1.85,d:2.65}},
 ...[[-10,3],[-10,-1],[-9,-5],[-9,-9],[-5,-10],[-1,-11],[3,-11],[7,-10],[10,-7],[10,-3],[10,1],[-11,7]].map(([x,z])=>({x,z,r:.35}))]},
 home:{name:'林间的家',interior:true,asset:'./home-interior.glb?v=fg-a6962789a46b0e01',renderer:'glb',background:'#d9cbbb',light:2.1,radius:8,viewSpan:17,bounds:{w:11.5,d:9.5},floor:.14,view:{x:0,z:.5},spawn:{x:0,z:4.35},plan:{w:12,d:10,wallHeight:3,dividerZ:-.6,doorCenters:[-3,3],doorWidth:2},beds:HOME_BEDS,walls:HOME_WALLS,furniture:HOME_FURNITURE,
 ...
 museum:{name:'拾光收藏馆',interior:true,renderer:'museum',decorAssets:['./museum-interior.glb?v=fg-a6962789a46b0e01'],background:'#d5cdbb',light:2.2,radius:7,viewSpan:14.8,bounds:{w:9.5,d:7.5},floor:.14,view:{x:0,z:0},spawn:{x:0,z:3.2},plan:{w:10,d:8},displays:MUSEUM_DISPLAYS,
 ...
 hall:{name:'炉光公共厅',interior:true,asset:'./public-hall.glb?v=fg-a6962789a46b0e01',renderer:'glb',background:'#d7c8b5',light:2.1,radius:9,viewSpan:18,bounds:{w:13.5,d:8.5},floor:.14,view:{x:0,z:0},spawn:{x:0,z:3.85},plan:{w:14,d:9},furniture:HALL_FURNITURE,
 ...
 dormitory:{name:'公共厅楼上',interior:true,asset:'./hall-dormitory.glb?v=fg-a6962789a46b0e01',renderer:'glb',background:'#d6cbbb',light:2,radius:9,viewSpan:18,bounds:{w:13.5,d:8.5},floor:.14,view:{x:0,z:0},spawn:{x:5.7,z:3.3},plan:{w:14,d:9},rooms:DORM_ROOMS,walls:DORM_WALLS,
 ...
 garden.asset='./village-ground.glb?v=fg-a6962789a46b0e01';garden.decorAssets=[];
 ...
 const districtAssets=['./village-home.glb?v=fg-a6962789a46b0e01','./village-hall.glb?v=fg-a6962789a46b0e01','./village-neighbor1.glb?v=fg-a6962789a46b0e01','./village-neighbor2.glb?v=fg-a6962789a46b0e01','./village-neighbor3.glb?v=fg-a6962789a46b0e01','./village-pond.glb?v=fg-a6962789a46b0e01','./village-museum.glb?v=fg-a6962789a46b0e01'];
 ...
 garden.chunks.push({id:'lake-far',x:18,z:-2,radius:12,asset:'./village-lake-far.glb?v=fg-a6962789a46b0e01'});
 ...
 garden.oldTower={x:0,z:-46,r:2.65,height:10.5,door:{x:0,z:-42.65},
  ...
  chunks:[{id:'northwood-edge',x:0,z:-24,radius:16,asset:'./village-northwood-edge.glb?v=fg-a6962789a46b0e01'},
   {id:'northwood-deep',x:0,z:-35,radius:16,asset:'./village-northwood-deep.glb?v=fg-a6962789a46b0e01'},
   {id:'old-tower',x:0,z:-47,radius:15,asset:'./village-old-tower.glb?v=fg-a6962789a46b0e01'}]};
 ...
 garden.chunks.push({id:'fallen-tree',x:8.45,z:-34,radius:5,asset:'./opening-fallen-tree.glb?v=fg-a6962789a46b0e01'});
 ...
 garden.station={
  ...
  chunks:[{id:'station-lane',x:-5,z:29,radius:9,asset:'./village-station-lane.glb?v=fg-a6962789a46b0e01'},
   {id:'station',x:0,z:43.5,radius:18.5,asset:'./village-station.glb?v=fg-a6962789a46b0e01'}]
 };
 ...
 const attic={name:'星图阁楼',interior:true,renderer:'glb',asset:'./neighbor1-interior.glb?v=fg-a6962789a46b0e01',background:'#cbc8c2',light:2.1,radius:13,bounds:{w:20,d:15},viewSpan:13.8,floor:.14,view:{x:0,z:0},spawn:{x:0,z:5.9},
 ...
 Object.assign(garden.sites.market,{label:'灯串集市',text:'灯串下散着药草棚、奇物摊、茶摊和小花车。可以先来逛逛，摊位交易还没开放。'});
 ...
 garden.chunks.push({id:'market',x:-.3,z:-4,radius:8,asset:'./village-market.glb?v=fg-a6962789a46b0e01'});
 ...
 const tower={name:'苔灯书塔',interior:true,renderer:'glb',asset:'./neighbor2-interior.glb?v=fg-a6962789a46b0e01',background:'#cacbbd',light:2.1,radius:13,bounds:{w:21,d:15},viewSpan:13.8,floor:.14,view:{x:-2,z:0},spawn:{x:-2,z:6.15},
 ...
 const greenhouse={name:'铃叶花舍',interior:true,renderer:'glb',asset:'./neighbor3-interior.glb?v=fg-a6962789a46b0e01',background:'#d6d5c5',light:2.1,radius:15,bounds:{w:24,d:16},viewSpan:13.8,floor:.14,view:{x:0,z:0},spawn:{x:0,z:6.2},
 ...
 const observatory={name:'旧塔观星室',interior:true,renderer:'glb',asset:'./old-tower-interior.glb?v=fg-a6962789a46b0e01',background:'#b8c3c0',light:1.8,radius:12,bounds:{w:18,d:16},viewSpan:14.5,floor:.14,view:{x:0,z:-.4},spawn:{x:0,z:6.1},
 ...
 observatory.decorAssets=['./opening-tower-vines.glb?v=fg-a6962789a46b0e01'];
 ...
 garden.chunks.push({id:'reed-bridge',x:reed.x,z:0,radius:5,asset:'./opening-reed-bridge.glb?v=fg-a6962789a46b0e01'});
 ...
 garden.watermill={parts:[{x:38.5,z:7.3,w:5.2,d:5.4,h:3.8},{x:41.6,z:9.1,w:1.9,d:3.6,h:2.5}],door:{x:37.1,z:10.55},creek:millCreek,width:garden.lake.creekWidth,
  ...
  chunk:{id:'watermill',x:37,z:8.5,radius:13,asset:'./village-watermill.glb?v=fg-a6962789a46b0e01'}};
 ...
 const workshop={name:'水磨草药工坊',interior:true,renderer:'glb',asset:'./watermill-interior.glb?v=fg-a6962789a46b0e01',background:'#cec9b9',light:2,radius:15,bounds:{w:23,d:16},viewSpan:15.5,floor:.14,view:{x:0,z:0},spawn:{x:0,z:6.1},
 ...
 flowers:{map:'garden',target:MAPS.garden.stations.garden,label:'照料月光花',gesture:'water'},herbs:{map:'forest',target:{x:.1,z:2.48},label:'观察铃叶草',gesture:'gather'},mushrooms:{map:'forest',target:{x:2.6,z:.98},label:'寻找会发光的蘑菇',gesture:'gather'},pond:{map:'forest',target:{x:-.7,z:.6},label:'在池边观察水纹',gesture:'read'},study:{map:'garden',target:MAPS.garden.sites.hall.target,label:'翻看魔法笔记',gesture:'read'},potion:{map:'garden',target:MAPS.garden.stations.brew,label:'研究炼药锅里的微光',gesture:'read'},glow:{map:'forest',target:{x:1.7,z:3},label:'等草丛里的萤光亮起来',gesture:'rest'},home:{map:'garden',target:MAPS.garden.stations.rest,label:'在屋前歇脚',gesture:'rest'},rain:{map:'garden',target:MAPS.garden.stations.rest,label:'在屋檐下听雨',gesture:'read'},star:{map:'garden',target:MAPS.garden.stations.star,label:'看看星铃花的新芽',gesture:'read'},dive:{map:'garden',target:MAPS.garden.stations.well,label:'在井口往下看看',gesture:'read'},
  ...
  market:{map:'garden',target:MAPS.garden.sites.market.target,label:'到灯串集市走走',gesture:'rest'},
  ...
  railway:{map:'garden',target:MAPS.garden.station.target,label:'在林边车站的雨棚下等一会儿',gesture:'rest'},
 ...
 const GIFT_FAMILIES={flower:{label:'花',what:'月光花、星铃花，还有梦种长成的梦花'},dew:{label:'月露',what:'锅里炼出来、工坊蒸出来的月露'},herb:{label:'草木',what:'林地里采的铃叶草、荧光菇'},echo:{label:'回声一类',what:'井里带回的回声石，和用它做出来的东西'},dream:{label:'梦一类',what:'井里带回的梦屑，和用它做出来的东西'},sense:{label:'感官一类',what:'井里带回的感官晶，和用它做出来的东西'},relic:{label:'旧物一类',what:'井里带回的沉睡旧物、无名遗物，和修好、做出来的东西'}};
 ...
 root.FairyGardenRules={COMPANION_DESTINATIONS,GIFT_FAMILIES,GIFT_STANCES,WELL_CURIOS,WELL_TIDES,WELL_KITS,wellTide,wellContext,wellWeights,wellFind,VILLAGE_ZONES,villagePoint,migrateVillagePosition,START,TREES,NODES,MAPS,ACTIVITIES,SEASONS,DEPTH_MAX,DEPTH_BASE,depthNodes,seasonOf,weather,normalizePlan,hitInteraction};
})(globalThis);
