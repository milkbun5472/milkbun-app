...
(function(root){
 ...
 home:{name:'林间的家',interior:true,asset:'./home-interior.glb?v=fg-f1d39d10a89c2cd9',renderer:'glb',background:'#d9cbbb',light:2.1,radius:8,viewSpan:17,bounds:{w:11.5,d:9.5},floor:.14,view:{x:0,z:.5},spawn:{x:0,z:4.35},plan:{w:12,d:10,wallHeight:3,dividerZ:-.6,doorCenters:[-3,3],doorWidth:2},beds:HOME_BEDS,walls:HOME_WALLS,furniture:HOME_FURNITURE,
 ...
 museum:{name:'拾光收藏馆',interior:true,renderer:'museum',decorAssets:['./museum-interior.glb?v=fg-f1d39d10a89c2cd9'],background:'#d5cdbb',light:2.2,radius:7,viewSpan:14.8,bounds:{w:9.5,d:7.5},floor:.14,view:{x:0,z:0},spawn:{x:0,z:3.2},plan:{w:10,d:8},displays:MUSEUM_DISPLAYS,
 ...
 hall:{name:'炉光公共厅',interior:true,asset:'./public-hall.glb?v=fg-f1d39d10a89c2cd9',renderer:'glb',background:'#d7c8b5',light:2.1,radius:9,viewSpan:18,bounds:{w:13.5,d:8.5},floor:.14,view:{x:0,z:0},spawn:{x:0,z:3.85},plan:{w:14,d:9},furniture:HALL_FURNITURE,
 ...
 dormitory:{name:'公共厅楼上',interior:true,asset:'./hall-dormitory.glb?v=fg-f1d39d10a89c2cd9',renderer:'glb',background:'#d6cbbb',light:2,radius:9,viewSpan:18,bounds:{w:13.5,d:8.5},floor:.14,view:{x:0,z:0},spawn:{x:5.7,z:3.3},plan:{w:14,d:9},rooms:DORM_ROOMS,walls:DORM_WALLS,
 ...
 garden.asset='./village-ground.glb?v=fg-f1d39d10a89c2cd9';garden.decorAssets=[];
 ...
 const districtAssets=['./village-home.glb?v=fg-f1d39d10a89c2cd9','./village-hall.glb?v=fg-f1d39d10a89c2cd9','./village-neighbor1.glb?v=fg-f1d39d10a89c2cd9','./village-neighbor2.glb?v=fg-f1d39d10a89c2cd9','./village-neighbor3.glb?v=fg-f1d39d10a89c2cd9','./village-pond.glb?v=fg-f1d39d10a89c2cd9','./village-museum.glb?v=fg-f1d39d10a89c2cd9'];
 ...
 garden.chunks.push({id:'lake-far',x:18,z:-2,radius:12,asset:'./village-lake-far.glb?v=fg-f1d39d10a89c2cd9'});
