...
(function(root){
 ...
 home:{name:'林间的家',interior:true,asset:'./home-interior.glb?v=fg-aeb880fda881a770',renderer:'glb',background:'#d9cbbb',light:2.1,radius:8,viewSpan:17,bounds:{w:11.5,d:9.5},floor:.14,view:{x:0,z:.5},spawn:{x:0,z:4.35},plan:{w:12,d:10,wallHeight:3,dividerZ:-.6,doorCenters:[-3,3],doorWidth:2},beds:HOME_BEDS,walls:HOME_WALLS,furniture:HOME_FURNITURE,
 ...
 museum:{name:'拾光收藏馆',interior:true,renderer:'museum',decorAssets:['./museum-interior.glb?v=fg-aeb880fda881a770'],background:'#d5cdbb',light:2.2,radius:7,viewSpan:14.8,bounds:{w:9.5,d:7.5},floor:.14,view:{x:0,z:0},spawn:{x:0,z:3.2},plan:{w:10,d:8},displays:MUSEUM_DISPLAYS,
 ...
 hall:{name:'炉光公共厅',interior:true,asset:'./public-hall.glb?v=fg-aeb880fda881a770',renderer:'glb',background:'#d7c8b5',light:2.1,radius:9,viewSpan:18,bounds:{w:13.5,d:8.5},floor:.14,view:{x:0,z:0},spawn:{x:0,z:3.85},plan:{w:14,d:9},furniture:HALL_FURNITURE,
 ...
 dormitory:{name:'公共厅楼上',interior:true,asset:'./hall-dormitory.glb?v=fg-aeb880fda881a770',renderer:'glb',background:'#d6cbbb',light:2,radius:9,viewSpan:18,bounds:{w:13.5,d:8.5},floor:.14,view:{x:0,z:0},spawn:{x:5.7,z:3.3},plan:{w:14,d:9},rooms:DORM_ROOMS,walls:DORM_WALLS,
 ...
 garden.asset='./village-ground.glb?v=fg-aeb880fda881a770';garden.decorAssets=[];
 ...
 const districtAssets=['./village-home.glb?v=fg-aeb880fda881a770','./village-hall.glb?v=fg-aeb880fda881a770','./village-neighbor1.glb?v=fg-aeb880fda881a770','./village-neighbor2.glb?v=fg-aeb880fda881a770','./village-neighbor3.glb?v=fg-aeb880fda881a770','./village-pond.glb?v=fg-aeb880fda881a770','./village-museum.glb?v=fg-aeb880fda881a770'];
 ...
 garden.chunks.push({id:'lake-far',x:18,z:-2,radius:12,asset:'./village-lake-far.glb?v=fg-aeb880fda881a770'});
 ...
 garden.oldTower={x:0,z:-46,r:2.65,height:10.5,door:{x:0,z:-42.65},
  ...
  chunks:[{id:'northwood-edge',x:0,z:-24,radius:16,asset:'./village-northwood-edge.glb?v=fg-aeb880fda881a770'},
   {id:'northwood-deep',x:0,z:-35,radius:16,asset:'./village-northwood-deep.glb?v=fg-aeb880fda881a770'},
   {id:'old-tower',x:0,z:-47,radius:15,asset:'./village-old-tower.glb?v=fg-aeb880fda881a770'}]};
 ...
 garden.chunks.push({id:'fallen-tree',x:8.45,z:-34,radius:5,asset:'./opening-fallen-tree.glb?v=fg-aeb880fda881a770'});
 ...
 garden.station={
  ...
  chunks:[{id:'station-lane',x:-5,z:29,radius:9,asset:'./village-station-lane.glb?v=fg-aeb880fda881a770'},
   {id:'station',x:0,z:43.5,radius:18.5,asset:'./village-station.glb?v=fg-aeb880fda881a770'}]
 };
 ...
 const attic={name:'星图阁楼',interior:true,renderer:'glb',asset:'./neighbor1-interior.glb?v=fg-aeb880fda881a770',background:'#cbc8c2',light:2.1,radius:13,bounds:{w:20,d:15},viewSpan:13.8,floor:.14,view:{x:0,z:0},spawn:{x:0,z:5.9},
 ...
 garden.chunks.push({id:'market',x:-.3,z:-4,radius:8,asset:'./village-market.glb?v=fg-aeb880fda881a770'});
 ...
 const tower={name:'苔灯书塔',interior:true,renderer:'glb',asset:'./neighbor2-interior.glb?v=fg-aeb880fda881a770',background:'#cacbbd',light:2.1,radius:13,bounds:{w:21,d:15},viewSpan:13.8,floor:.14,view:{x:-2,z:0},spawn:{x:-2,z:6.15},
 ...
 const greenhouse={name:'铃叶花舍',interior:true,renderer:'glb',asset:'./neighbor3-interior.glb?v=fg-aeb880fda881a770',background:'#d6d5c5',light:2.1,radius:15,bounds:{w:24,d:16},viewSpan:13.8,floor:.14,view:{x:0,z:0},spawn:{x:0,z:6.2},
 ...
 const observatory={name:'旧塔观星室',interior:true,renderer:'glb',asset:'./old-tower-interior.glb?v=fg-aeb880fda881a770',background:'#b8c3c0',light:1.8,radius:12,bounds:{w:18,d:16},viewSpan:14.5,floor:.14,view:{x:0,z:-.4},spawn:{x:0,z:6.1},
 ...
 observatory.decorAssets=['./opening-tower-vines.glb?v=fg-aeb880fda881a770'];
 ...
 garden.chunks.push({id:'reed-bridge',x:reed.x,z:0,radius:5,asset:'./opening-reed-bridge.glb?v=fg-aeb880fda881a770'});
 ...
 garden.watermill={parts:[{x:38.5,z:7.3,w:5.2,d:5.4,h:3.8},{x:41.6,z:9.1,w:1.9,d:3.6,h:2.5}],door:{x:37.1,z:10.55},creek:millCreek,width:garden.lake.creekWidth,
  ...
  chunk:{id:'watermill',x:37,z:8.5,radius:13,asset:'./village-watermill.glb?v=fg-aeb880fda881a770'}};
 ...
 const workshop={name:'水磨草药工坊',interior:true,renderer:'glb',asset:'./watermill-interior.glb?v=fg-aeb880fda881a770',background:'#cec9b9',light:2,radius:15,bounds:{w:23,d:16},viewSpan:15.5,floor:.14,view:{x:0,z:0},spawn:{x:0,z:6.1},
