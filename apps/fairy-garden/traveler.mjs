import {makeDollLife} from './doll-life.mjs?v=fg-acdcf150406acdc4';
import {mergeLook,outfitId,outfitColors,hairId,hairModeOf,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-acdcf150406acdc4';
