import {makeDollLife} from './doll-life.mjs?v=fg-1624392ca5caaadd';
import {mergeLook,outfitId,outfitColors,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-1624392ca5caaadd';
