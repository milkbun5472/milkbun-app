import {makeDollLife} from './doll-life.mjs?v=fg-4edb7706b6dfbc0a';
import {mergeLook,outfitId,outfitColors,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-4edb7706b6dfbc0a';
