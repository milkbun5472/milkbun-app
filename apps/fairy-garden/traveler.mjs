import {makeDollLife} from './doll-life.mjs?v=fg-0fa4d02be9d6af65';
import {mergeLook,outfitId,outfitColors,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-0fa4d02be9d6af65';
