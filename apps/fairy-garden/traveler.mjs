import {makeDollLife} from './doll-life.mjs?v=fg-d6c699fdeba47ce3';
import {mergeLook,outfitId,outfitColors,hairId,hairModeOf,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-d6c699fdeba47ce3';
