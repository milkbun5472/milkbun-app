import {makeDollLife} from './doll-life.mjs?v=fg-7721f2e1c45a3b3d';
import {mergeLook,outfitId,outfitColors,hairId,hairModeOf,DEFAULT_LOOK,COMPANION_LOOK,DEFAULT_EYE} from './wardrobe.mjs?v=fg-7721f2e1c45a3b3d';
