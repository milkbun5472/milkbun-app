import {makeDollLife} from './doll-life.mjs?v=fg-8ad597cb779a8b50';
import {mergeLook,outfitId,outfitColors,hairId,hairModeOf,DEFAULT_LOOK,COMPANION_LOOK,DEFAULT_EYE} from './wardrobe.mjs?v=fg-8ad597cb779a8b50';
