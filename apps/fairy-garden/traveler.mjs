import {mergeLook,outfitId,outfitColors,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-bb93ff38b286d93a';
...
export function createTraveler(source,companion=false,look={}){
 ...
 return {root,setLook(next){const n=mergeLook(want,next||{});if(HAIR_STYLES.includes(n.hair)){model.traverse(o=>{if(o.isMesh&&isHair(o))o.visible=o.name==='hair_'+n.hair;});}
