import {makeDollLife} from './doll-life.mjs?v=fg-c967724666ff79a3';
import {mergeLook,outfitId,outfitColors,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-c967724666ff79a3';
