import {makeDollLife} from './doll-life.mjs?v=fg-7eaaa9dfa3dee45b';
import {mergeLook,outfitId,outfitColors,hairId,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-7eaaa9dfa3dee45b';
