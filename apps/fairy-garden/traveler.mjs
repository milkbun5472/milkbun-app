import {makeDollLife} from './doll-life.mjs?v=fg-d39a3254c95fc109';
import {mergeLook,outfitId,outfitColors,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-d39a3254c95fc109';
