import {makeDollLife} from './doll-life.mjs?v=fg-9a661bf4df64382b';
import {mergeLook,outfitId,outfitColors,hairId,hairModeOf,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-9a661bf4df64382b';
