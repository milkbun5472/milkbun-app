import {makeDollLife} from './doll-life.mjs?v=fg-abbd8764bdff5068';
import {mergeLook,outfitId,outfitColors,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-abbd8764bdff5068';
