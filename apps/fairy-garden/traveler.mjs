import {makeDollLife} from './doll-life.mjs?v=fg-0a8b6fcba0caf3a7';
import {mergeLook,outfitId,outfitColors,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-0a8b6fcba0caf3a7';
