import {makeDollLife} from './doll-life.mjs?v=fg-dc9ff4745fd4acb8';
import {mergeLook,outfitId,outfitColors,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-dc9ff4745fd4acb8';
