import {makeDollLife} from './doll-life.mjs?v=fg-203678530265f0fa';
import {mergeLook,outfitId,outfitColors,hairId,hairModeOf,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-203678530265f0fa';
