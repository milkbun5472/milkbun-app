import {makeDollLife} from './doll-life.mjs?v=fg-dde0d9dadc846f1e';
import {mergeLook,outfitId,outfitColors,hairId,hairModeOf,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-dde0d9dadc846f1e';
