import {makeDollLife} from './doll-life.mjs?v=fg-367961cd8d7e618c';
import {mergeLook,outfitId,outfitColors,hairId,hairModeOf,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-367961cd8d7e618c';
