import {makeDollLife} from './doll-life.mjs?v=fg-82659e981fafba6e';
import {mergeLook,outfitId,outfitColors,hairId,hairModeOf,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-82659e981fafba6e';
