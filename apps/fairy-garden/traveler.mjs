import {makeDollLife} from './doll-life.mjs?v=fg-7b18afc24fec577f';
import {mergeLook,outfitId,outfitColors,hairId,hairModeOf,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-7b18afc24fec577f';
