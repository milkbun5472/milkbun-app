import {makeDollLife} from './doll-life.mjs?v=fg-2b31fc9769f83a61';
import {mergeLook,outfitId,outfitColors,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-2b31fc9769f83a61';
