import {makeDollLife} from './doll-life.mjs?v=fg-f074ecbbbab15c50';
import {mergeLook,outfitId,outfitColors,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-f074ecbbbab15c50';
