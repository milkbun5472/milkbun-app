import {makeDollLife} from './doll-life.mjs?v=fg-194c9a0f17f7facc';
import {mergeLook,outfitId,outfitColors,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-194c9a0f17f7facc';
