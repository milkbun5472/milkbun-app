import {makeDollLife} from './doll-life.mjs?v=fg-5736d962774e29d9';
import {mergeLook,outfitId,outfitColors,hairId,hairModeOf,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-5736d962774e29d9';
