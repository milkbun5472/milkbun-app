import {makeDollLife} from './doll-life.mjs?v=fg-da70aec4cf65bb87';
import {mergeLook,outfitId,outfitColors,hairId,hairModeOf,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-da70aec4cf65bb87';
