import {makeDollLife} from './doll-life.mjs?v=fg-889d70de4a4db0b3';
import {mergeLook,outfitId,outfitColors,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-889d70de4a4db0b3';
