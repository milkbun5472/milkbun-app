import {makeDollLife} from './doll-life.mjs?v=fg-b89ddca61fd6dcb7';
import {mergeLook,outfitId,outfitColors,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-b89ddca61fd6dcb7';
