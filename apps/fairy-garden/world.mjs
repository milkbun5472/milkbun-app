import {OUTFITS,restoreWardrobe} from './wardrobe.mjs?v=fg-a724e4821561c629';
import {brewError,brewResult} from './brewing.mjs?v=fg-a724e4821561c629';
import {restoreWorkshop,restoreWaterLights,waterLightError,releaseWaterLight,millError,startMill,collectMill,helpMill,MILL_RECIPES,millRemaining} from './workshop.mjs?v=fg-a724e4821561c629';
import './rules.js?v=fg-a724e4821561c629';
...
import {createNavigator} from './navigation.mjs?v=fg-a724e4821561c629';
...
export function calendarMarks(s, birthday = 0){
  ...
  for (let d = 1; d <= 14; d++){ const abs = season.start + d - 1; if (marketDay(abs)) add(d, '集市'); if ((abs - 1) % QUEST_CYCLE === 0) add(d, '换板子'); }
