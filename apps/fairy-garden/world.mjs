import {restorePuzzleMemory,restoreBack} from '../train/puzzle-memory.mjs?v=fg-7721f2e1c45a3b3d';
import {validImage} from '../train/album.mjs?v=fg-7721f2e1c45a3b3d';
import {KNOWN_OUTFITS,HAIR_MODES,restoreWardrobe} from './wardrobe.mjs?v=fg-7721f2e1c45a3b3d';
import {brewError,brewResult} from './brewing.mjs?v=fg-7721f2e1c45a3b3d';
import {restoreWorkshop,restoreWaterLights,activeWaterLights,gameMinute,waterLightError,releaseWaterLight,millError,startMill,collectMill,helpMill,MILL_RECIPES,millRemaining} from './workshop.mjs?v=fg-7721f2e1c45a3b3d';
import './rules.js?v=fg-7721f2e1c45a3b3d';
...
import {createNavigator} from './navigation.mjs?v=fg-7721f2e1c45a3b3d';
...
export function restoreLook(raw){
 ...
 for(const k of ['hairColor','hairColor2','cloth','skin','eye'])if(typeof d[k]==='string'&&/^#[0-9a-fA-F]{6}$/.test(d[k]))out[k]=d[k];
