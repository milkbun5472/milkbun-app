...
import {MAPS,COMPANION_DESTINATIONS,ACTIVITIES,seasonOf,weather,exitToward,findPath,segmentClear,walkable,companionCare,onLakeIce,missWanting,missGaveUp} from './world.mjs?v=fg-c731a029f2ffd6d8';
