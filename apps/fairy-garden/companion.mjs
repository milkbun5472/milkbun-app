import {MAPS,COMPANION_DESTINATIONS,ACTIVITIES,seasonOf,weather,exitToward,findPath,segmentClear,walkable,companionCare,missWanting,missGaveUp} from './world.mjs?v=fg-e8e9bd175f1dc8b4';
