...
import {MAPS,SEED_PLOTS,dreamStage,spotParse,seedPlot} from './world.mjs?v=fg-c967724666ff79a3';
import {makeCurio} from './curio-view.mjs?v=fg-c967724666ff79a3';
import {makeDreamFlower} from './keepsake-view.mjs?v=fg-c967724666ff79a3';
