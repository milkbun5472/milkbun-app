 ...
 *
 * @augments Loader
 * @three_import import { DRACOLoader } from 'three/addons/loaders/DRACOLoader.js?v=fg-d8bdabe9d782b029';
 */
class DRACOLoader extends Loader {
	...
	_initDecoder() {
		...
		if ( useJS ) {
			...
			librariesPending.push( this._loadLibrary( 'draco_decoder.js?v=fg-d8bdabe9d782b029', 'text' ) );

		} else {

			librariesPending.push( this._loadLibrary( 'draco_wasm_wrapper.js?v=fg-d8bdabe9d782b029', 'text' ) );
