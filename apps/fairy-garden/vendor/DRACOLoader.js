 ...
 *
 * @augments Loader
 * @three_import import { DRACOLoader } from 'three/addons/loaders/DRACOLoader.js?v=fg-eca146e8fbb06ec9';
 */
class DRACOLoader extends Loader {
	...
	_initDecoder() {
		...
		if ( useJS ) {
			...
			librariesPending.push( this._loadLibrary( 'draco_decoder.js?v=fg-eca146e8fbb06ec9', 'text' ) );

		} else {

			librariesPending.push( this._loadLibrary( 'draco_wasm_wrapper.js?v=fg-eca146e8fbb06ec9', 'text' ) );
