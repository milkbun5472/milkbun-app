 ...
 *
 * @augments Loader
 * @three_import import { DRACOLoader } from 'three/addons/loaders/DRACOLoader.js?v=fg-8ad597cb779a8b50';
 */
class DRACOLoader extends Loader {
	...
	_initDecoder() {
		...
		if ( useJS ) {
			...
			librariesPending.push( this._loadLibrary( 'draco_decoder.js?v=fg-8ad597cb779a8b50', 'text' ) );

		} else {

			librariesPending.push( this._loadLibrary( 'draco_wasm_wrapper.js?v=fg-8ad597cb779a8b50', 'text' ) );
