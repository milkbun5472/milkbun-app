import {stepRoute} from './locomotion.mjs?v=fg-5919651822291a8f';
import {makeLakeView} from './lake-view.mjs?v=fg-5919651822291a8f';
import {makeMuseum} from './museum-view.mjs?v=fg-5919651822291a8f';
import {museumCaption} from './museum.mjs?v=fg-5919651822291a8f';
import {makeOutdoor} from './outdoor.mjs?v=fg-5919651822291a8f';
import {installSeasonBook} from './season-book.mjs?v=fg-5919651822291a8f';
import {makeMagicView} from './magic-view.mjs?v=fg-5919651822291a8f';
import {installViewControls,orthographicPanDelta} from './view-controls.mjs?v=fg-5919651822291a8f';
import * as THREE from 'three';
import {createMapLoader} from './map-loader.mjs?v=fg-5919651822291a8f';
import {makeSurroundings} from './surroundings.mjs?v=fg-5919651822291a8f';
import {GLTFLoader} from './vendor/GLTFLoader.js?v=fg-5919651822291a8f';
import {START,MAPS,NODES,lakeFrozen,onLakeIce,weather,targetFor,actionError,walkable,findPath,perform,restoreState,freshState,COMPANION_DESTINATIONS,advanceTime,timeLabel,gardenIntent,seasonOf,hitInteraction,journalText,companionNearby,floorHeight,groundPoint,exitFor,sleepPose,wakeSleeper,deepestAllowed,SEED_KINDS,SEED_DAYS,SEED_PER_DAY,seedError,sowSeed,seedsToday,readySeeds,keepNotes,pinNote,SHARD_KINDS,VEIN_POOL,veinLow,fillVein,pinShard,CRAFT_WAYS,SPOTS,craftError,craftThing,placeThing,placedAt,thingReady,bellRings,donate,donateError,collectedKinds,recipeIndex,RECIPE_TOTAL,driftPick,driftError,drawBottle,BOTTLE_DAYS,recentHappenings,diveWet,mapFoggy,MAP_FOG_RANGE,SPELLS,SPELL_PLACES,restoreSpells,castError,castSpell,castAt,castLine,spellOfSeason,sealBottle,sealError,floating,missArrived,missWaiting,missGaveUp,missLetGo,missTaken,missMaterial,talkedWith,QUEST_KINDS,QUEST_TAKEN_MAX,QUEST_CYCLE,questBoard,questTaken,questCycle,questPaid,takeError,takeQuest,turnIn,lampOn,lampShelter} from './world.mjs?v=fg-5919651822291a8f';
import {makeForest} from './forest.mjs?v=fg-5919651822291a8f';
import {makeDepths} from './depths.mjs?v=fg-5919651822291a8f';
import {createTraveler} from './traveler.mjs?v=fg-5919651822291a8f';
import {makeCompanionController,dailySchedule,plannedActivity} from './companion.mjs?v=fg-5919651822291a8f';const $=id=>document.getElementById(id),KEY='fairy-garden-prototype-v1';
