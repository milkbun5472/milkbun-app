import {mergeLook,outfitColors,outfitId,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-5ed78fbf66e1adb4';
import {repairError} from './world.mjs?v=fg-5ed78fbf66e1adb4';
import {makeCurio} from './curio-view.mjs?v=fg-5ed78fbf66e1adb4';
import {makePlacedKeepsakes} from './keepsake-view.mjs?v=fg-5ed78fbf66e1adb4';
import {growingDreams,dreamStage,dreamError,SEED_PLOTS} from './world.mjs?v=fg-5ed78fbf66e1adb4';
import {makeDreamGarden} from './dream-view.mjs?v=fg-5ed78fbf66e1adb4';
import {WELL_CURIOS,WELL_KITS,wellTide,wellContext,chooseWellKit,shardName} from './world.mjs?v=fg-5ed78fbf66e1adb4';
import {makeWellSigns} from './well-view.mjs?v=fg-5ed78fbf66e1adb4';
import {makeExcavatingView} from './excavating-view.mjs?v=fg-5ed78fbf66e1adb4';
import {makeRitualView} from './ritual-view.mjs?v=fg-5ed78fbf66e1adb4';
import {makeScoopingView} from './scooping-view.mjs?v=fg-5ed78fbf66e1adb4';
import {weatherLook} from './weather-look.mjs?v=fg-5ed78fbf66e1adb4';
import {BREWS,brewKey} from './brewing.mjs?v=fg-5ed78fbf66e1adb4';
import {makeBrewingView} from './brewing-view.mjs?v=fg-5ed78fbf66e1adb4';
import {MILL_RECIPES,materialLine,millRemaining,millError} from './workshop.mjs?v=fg-5ed78fbf66e1adb4';
import {makeWorkshopView} from './workshop-view.mjs?v=fg-5ed78fbf66e1adb4';
import {openingTag} from './opening-view.mjs?v=fg-5ed78fbf66e1adb4';
import {stepRoute} from './locomotion.mjs?v=fg-5ed78fbf66e1adb4';
import {makeLakeView} from './lake-view.mjs?v=fg-5ed78fbf66e1adb4';
import {makeMuseum} from './museum-view.mjs?v=fg-5ed78fbf66e1adb4';
import {museumCaption} from './museum.mjs?v=fg-5ed78fbf66e1adb4';
import {makeOutdoor} from './outdoor.mjs?v=fg-5ed78fbf66e1adb4';
import {installSeasonBook} from './season-book.mjs?v=fg-5ed78fbf66e1adb4';
import {makeMagicView} from './magic-view.mjs?v=fg-5ed78fbf66e1adb4';
import {installViewControls,orthographicPanDelta,orthographicCameraPose} from './view-controls.mjs?v=fg-5ed78fbf66e1adb4';
import * as THREE from 'three';
import {createMapLoader} from './map-loader.mjs?v=fg-5ed78fbf66e1adb4';
import {makeSurroundings} from './surroundings.mjs?v=fg-5ed78fbf66e1adb4';
import {GLTFLoader} from './vendor/GLTFLoader.js?v=fg-5ed78fbf66e1adb4';
import {millAction,millAt,islandLightError,floatIslandLight,START,MAPS,NODES,lakeFrozen,onLakeIce,weather,targetFor,actionError,walkable,findPath,perform,restoreState,freshState,COMPANION_DESTINATIONS,advanceTime,timeLabel,gardenIntent,seasonOf,hitInteraction,journalText,companionNearby,floorHeight,groundPoint,exitFor,sleepPose,wakeSleeper,deepestAllowed,SEED_KINDS,SEED_DAYS,SEED_PER_DAY,seedError,sowSeed,seedsToday,readySeeds,keepNotes,pinNote,SHARD_KINDS,VEIN_POOL,veinLow,fillVein,pinShard,CRAFT_WAYS,SPOTS,spotsAll,spotKey,isSpot,spotLabel,spotParse,FURNITURE,furnitureAtPoint,approachSpot,lookText,craftError,craftThing,placeThing,placedAt,thingReady,hastenError,hastenThing,bellRings,donate,donateError,collectedKinds,recipeIndex,RECIPE_TOTAL,driftPick,driftError,drawBottle,BOTTLE_DAYS,recentHappenings,diveWet,mapFoggy,MAP_FOG_RANGE,restoreNeighbors,asCompanion,moveIn,moveOut,moveInError,neighborOf,freeHouse,NEIGHBOR_HOUSES,OPENINGS,isOpening,opened,openingLine,openingReady,WORKS,workHere,workError,workShort,workCost,doWork,workDone,worksDone,noteMeet,whereLabel,metCount,closeness,MEET_NEAR,SPELLS,SPELL_PLACES,restoreSpells,castError,castSpell,castAt,castLine,castPlaceError,spellOfSeason,sealBottle,sealError,floating,missArrived,missWaiting,missGaveUp,missLetGo,missTaken,missMaterial,talkedWith,QUEST_KINDS,QUEST_TAKEN_MAX,QUEST_CYCLE,questBoard,questTaken,questCycle,questPaid,takeError,takeQuest,turnIn,lampOn,lampShelter,walkSpeedFor} from './world.mjs?v=fg-5ed78fbf66e1adb4';
import {makeForest} from './forest.mjs?v=fg-5ed78fbf66e1adb4';
import {makeDepths} from './depths.mjs?v=fg-5ed78fbf66e1adb4';
import {createTraveler} from './traveler.mjs?v=fg-5ed78fbf66e1adb4';
import {makeCompanionController,dailySchedule,plannedActivity} from './companion.mjs?v=fg-5ed78fbf66e1adb4';const $=id=>document.getElementById(id),KEY='fairy-garden-prototype-v1';
