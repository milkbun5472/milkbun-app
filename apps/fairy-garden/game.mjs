import {installSeasonBook} from './season-book.mjs?v=fg-6ef0e61f3eb1bc5e';
import {makeMagicView} from './magic-view.mjs?v=fg-6ef0e61f3eb1bc5e';
import {installViewControls} from './view-controls.mjs?v=fg-6ef0e61f3eb1bc5e';
import * as THREE from 'three';
import {createMapLoader} from './map-loader.mjs?v=fg-6ef0e61f3eb1bc5e';
import {makeSurroundings} from './surroundings.mjs?v=fg-6ef0e61f3eb1bc5e';
import {GLTFLoader} from './vendor/GLTFLoader.js?v=fg-6ef0e61f3eb1bc5e';
import {START,MAPS,NODES,weather,targetFor,actionError,walkable,findPath,perform,restoreState,freshState,COMPANION_DESTINATIONS,advanceTime,timeLabel,gardenIntent,seasonOf,hitInteraction,journalText,companionNearby,floorHeight,deepestAllowed,SEED_KINDS,SEED_DAYS,seedError,sowSeed,readySeeds,keepNotes,pinNote} from './world.mjs?v=fg-6ef0e61f3eb1bc5e';
import {makeForest} from './forest.mjs?v=fg-6ef0e61f3eb1bc5e';
import {makeDepths} from './depths.mjs?v=fg-6ef0e61f3eb1bc5e';
import {createTraveler} from './traveler.mjs?v=fg-6ef0e61f3eb1bc5e';
import {makeCompanionController,dailySchedule,plannedActivity} from './companion.mjs?v=fg-6ef0e61f3eb1bc5e';
...
async function load(){try{const loader=assetLoader;await mapLoader.ensure(data.map);const a=await loader.loadAsync('./doll.glb?v=fg-6ef0e61f3eb1bc5e');playerAvatar=createTraveler(a.scene);actor=playerAvatar.root;actor.name='Player';scene.add(actor);companionAvatar=createTraveler(a.scene,true);companionAvatar.root.name='Companion';scene.add(companionAvatar.root);
