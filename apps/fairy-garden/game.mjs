import {receiveTravelArt,festivalDay,festivalOpen,festivalError,festivalMissing,festivalDone,holdFestival,festivalBook,atFestival,seatsOf,SEAT_KINDS,FOODS,RECIPE_COST,BAG_LABELS,foodOf,recipeOf,nightMarketDay,nightMarketOpen,nextNightMarket,nightStock,vendorAt,vendorOfFood,vendorSpot,VENDOR_STALLS,foodError,foodPay,foodLabel,buyFood,eatError,eat,cookError,cook,foodBook,restorePantry,giftOptions,giftError,giveGift,giftBook,giftKey,giftCatalogue,rolledStance,bondBook,companionDestinations,himGiveError,himGive,inviteError,invite,inviteMet,keepInvite,refuse,neighborNear,NEIGHBOR_REACH,neighborTalkError,noteNeighborTalk,neighborView,neighborWaveError,waveAtNeighbor,neighborGiftError,giveToNeighbor,neighborPairs,NEIGHBOR_HAND,MARKET_GOODS,marketOpen,atMarket,marketError,buy,starNightReady,keepStarNight,starChartPieces,STAR_CHART_NEED,spendTime,ACTION_MINUTES,guideStep,guideTarget,guideAdvance,guideSaid,markGuideSaid,setGuide,restoreGuide,todayHints,calendarMarks,marketDay,nextMarketDay,marketStock,marketGood,isBirthday,nearInteraction,seatAt} from './world.mjs?v=fg-dc9ff4745fd4acb8';
import {bubbleHold,bubbleShow,bubbleSay,BUBBLE_MAX,BUBBLE_GAP,VOICE_GAP} from './speech.mjs?v=fg-dc9ff4745fd4acb8';
import {actionGesture,actionDuration,makeHeldFlower} from './doll-life.mjs?v=fg-dc9ff4745fd4acb8';
import {mergeLook,outfitColors,outfitId,lookForTa,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-dc9ff4745fd4acb8';
import {repairError} from './world.mjs?v=fg-dc9ff4745fd4acb8';
import {makeCurio} from './curio-view.mjs?v=fg-dc9ff4745fd4acb8';
import {makePlacedKeepsakes} from './keepsake-view.mjs?v=fg-dc9ff4745fd4acb8';
import {growingDreams,dreamStage,dreamError,SEED_PLOTS} from './world.mjs?v=fg-dc9ff4745fd4acb8';
import {makeDreamGarden} from './dream-view.mjs?v=fg-dc9ff4745fd4acb8';
import {WELL_CURIOS,WELL_KITS,wellTide,wellContext,chooseWellKit,shardName} from './world.mjs?v=fg-dc9ff4745fd4acb8';
import {makeWellSigns} from './well-view.mjs?v=fg-dc9ff4745fd4acb8';
import {makeExcavatingView} from './excavating-view.mjs?v=fg-dc9ff4745fd4acb8';
import {makeStarChartView} from './starchart-view.mjs?v=fg-dc9ff4745fd4acb8';
import {makeMarketView} from './market-view.mjs?v=fg-dc9ff4745fd4acb8';
import {villagePlan,installMapZoom} from './village-map.mjs?v=fg-dc9ff4745fd4acb8';
import {makeRitualView} from './ritual-view.mjs?v=fg-dc9ff4745fd4acb8';
import {makeScoopingView} from './scooping-view.mjs?v=fg-dc9ff4745fd4acb8';
import {weatherLook} from './weather-look.mjs?v=fg-dc9ff4745fd4acb8';
import {BREWS,brewKey} from './brewing.mjs?v=fg-dc9ff4745fd4acb8';
import {makeBrewingView} from './brewing-view.mjs?v=fg-dc9ff4745fd4acb8';
import {MILL_RECIPES,materialLine,millRemaining,millError} from './workshop.mjs?v=fg-dc9ff4745fd4acb8';
import {makeWorkshopView} from './workshop-view.mjs?v=fg-dc9ff4745fd4acb8';
import {openingTag} from './opening-view.mjs?v=fg-dc9ff4745fd4acb8';
import {stepRoute} from './locomotion.mjs?v=fg-dc9ff4745fd4acb8';
import {makeLakeView} from './lake-view.mjs?v=fg-dc9ff4745fd4acb8';
import {makeMuseum} from './museum-view.mjs?v=fg-dc9ff4745fd4acb8';
import {museumCaption} from './museum.mjs?v=fg-dc9ff4745fd4acb8';
import {makeOutdoor} from './outdoor.mjs?v=fg-dc9ff4745fd4acb8';
import {installSeasonBook} from './season-book.mjs?v=fg-dc9ff4745fd4acb8';
import {makeMagicView} from './magic-view.mjs?v=fg-dc9ff4745fd4acb8';
import {installViewControls,orthographicPanDelta,orthographicCameraPose} from './view-controls.mjs?v=fg-dc9ff4745fd4acb8';
import * as THREE from 'three';
import {createMapLoader} from './map-loader.mjs?v=fg-dc9ff4745fd4acb8';
import {makeSurroundings} from './surroundings.mjs?v=fg-dc9ff4745fd4acb8';
import {GLTFLoader} from './vendor/GLTFLoader.js?v=fg-dc9ff4745fd4acb8';
...
async function load(){try{const loader=assetLoader;await mapLoader.ensure(data.map,data.position);const a=await loader.loadAsync('./doll.glb?v=fg-dc9ff4745fd4acb8');playerAvatar=createTraveler(a.scene);actor=playerAvatar.root;actor.name='Player';scene.add(actor);companionAvatar=createTraveler(a.scene,true);companionAvatar.root.name='Companion';scene.add(companionAvatar.root);dollSource=a.scene;marketView.setDoll(dollSource);syncNeighbors();
