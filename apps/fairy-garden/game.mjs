import {noteTravelBack,receiveTravelArt,festivalDay,festivalOpen,festivalError,festivalMissing,festivalDone,holdFestival,festivalBook,atFestival,seatsOf,SEAT_KINDS,FOODS,RECIPE_COST,BAG_LABELS,foodOf,recipeOf,nightMarketDay,nightMarketOpen,nextNightMarket,nightStock,vendorAt,vendorOfFood,vendorSpot,VENDOR_STALLS,foodError,foodPay,foodLabel,buyFood,eatError,eat,cookError,cook,foodBook,restorePantry,giftOptions,giftError,giveGift,giftBook,giftKey,giftCatalogue,rolledStance,bondBook,companionDestinations,himGiveError,himGive,inviteError,invite,inviteMet,keepInvite,refuse,neighborNear,NEIGHBOR_REACH,neighborTalkError,noteNeighborTalk,neighborView,neighborWaveError,waveAtNeighbor,neighborGiftError,giveToNeighbor,neighborPairs,NEIGHBOR_HAND,MARKET_GOODS,marketOpen,atMarket,marketError,buy,starNightReady,keepStarNight,starChartPieces,STAR_CHART_NEED,spendTime,ACTION_MINUTES,guideStep,guideTarget,guideAdvance,guideSaid,markGuideSaid,setGuide,restoreGuide,todayHints,calendarMarks,marketDay,nextMarketDay,marketStock,marketGood,isBirthday,nearInteraction,seatAt} from './world.mjs?v=fg-90623cddf5e68c9b';
import {bubbleHold,bubbleShow,bubbleSay,BUBBLE_MAX,BUBBLE_GAP,VOICE_GAP} from './speech.mjs?v=fg-90623cddf5e68c9b';
import {actionGesture,actionDuration,makeHeldFlower} from './doll-life.mjs?v=fg-90623cddf5e68c9b';
import {mergeLook,outfitColors,outfitId,hairId,dyesOf,HAIR_MODES,lookForTa,DEFAULT_LOOK,COMPANION_LOOK} from './wardrobe.mjs?v=fg-90623cddf5e68c9b';
import {repairError} from './world.mjs?v=fg-90623cddf5e68c9b';
import {makeCurio} from './curio-view.mjs?v=fg-90623cddf5e68c9b';
import {makePlacedKeepsakes} from './keepsake-view.mjs?v=fg-90623cddf5e68c9b';
import {growingDreams,dreamStage,dreamError,SEED_PLOTS} from './world.mjs?v=fg-90623cddf5e68c9b';
import {makeDreamGarden} from './dream-view.mjs?v=fg-90623cddf5e68c9b';
import {WELL_CURIOS,WELL_KITS,wellTide,wellContext,chooseWellKit,shardName} from './world.mjs?v=fg-90623cddf5e68c9b';
import {makeWellSigns} from './well-view.mjs?v=fg-90623cddf5e68c9b';
import {makeExcavatingView} from './excavating-view.mjs?v=fg-90623cddf5e68c9b';
import {makeStarChartView} from './starchart-view.mjs?v=fg-90623cddf5e68c9b';
import {makeMarketView} from './market-view.mjs?v=fg-90623cddf5e68c9b';
import {villagePlan,installMapZoom} from './village-map.mjs?v=fg-90623cddf5e68c9b';
import {makeRitualView} from './ritual-view.mjs?v=fg-90623cddf5e68c9b';
import {makeScoopingView} from './scooping-view.mjs?v=fg-90623cddf5e68c9b';
import {weatherLook} from './weather-look.mjs?v=fg-90623cddf5e68c9b';
import {BREWS,brewKey} from './brewing.mjs?v=fg-90623cddf5e68c9b';
import {makeBrewingView} from './brewing-view.mjs?v=fg-90623cddf5e68c9b';
import {MILL_RECIPES,materialLine,millRemaining,millError} from './workshop.mjs?v=fg-90623cddf5e68c9b';
import {makeWorkshopView} from './workshop-view.mjs?v=fg-90623cddf5e68c9b';
import {openingTag} from './opening-view.mjs?v=fg-90623cddf5e68c9b';
import {stepRoute} from './locomotion.mjs?v=fg-90623cddf5e68c9b';
import {makeLakeView} from './lake-view.mjs?v=fg-90623cddf5e68c9b';
import {makeMuseum} from './museum-view.mjs?v=fg-90623cddf5e68c9b';
import {museumCaption} from './museum.mjs?v=fg-90623cddf5e68c9b';
import {makeOutdoor} from './outdoor.mjs?v=fg-90623cddf5e68c9b';
import {installSeasonBook} from './season-book.mjs?v=fg-90623cddf5e68c9b';
import {makeMagicView} from './magic-view.mjs?v=fg-90623cddf5e68c9b';
import {installViewControls,orthographicPanDelta,orthographicCameraPose} from './view-controls.mjs?v=fg-90623cddf5e68c9b';
import * as THREE from 'three';
import {createMapLoader} from './map-loader.mjs?v=fg-90623cddf5e68c9b';
import {makeSurroundings} from './surroundings.mjs?v=fg-90623cddf5e68c9b';
import {GLTFLoader} from './vendor/GLTFLoader.js?v=fg-90623cddf5e68c9b';
...
async function load(){try{const loader=assetLoader;await mapLoader.ensure(data.map,data.position);const a=await loader.loadAsync('./doll.glb?v=fg-90623cddf5e68c9b');playerAvatar=createTraveler(a.scene);actor=playerAvatar.root;actor.name='Player';scene.add(actor);companionAvatar=createTraveler(a.scene,true);companionAvatar.root.name='Companion';scene.add(companionAvatar.root);dollSource=a.scene;marketView.setDoll(dollSource);syncNeighbors();
