...
import {GLTFLoader} from '../fairy-garden/vendor/GLTFLoader.js?v=fg-367961cd8d7e618c';
import {DRACOLoader} from '../fairy-garden/vendor/DRACOLoader.js?v=fg-367961cd8d7e618c';
import {createTraveler,setFaceBase} from '../fairy-garden/traveler.mjs?v=fg-367961cd8d7e618c';
import {lookForTa,mergeLook,dyesOf,outfitId,outfitColors,hairId,HAIR_MODES} from '../fairy-garden/wardrobe.mjs?v=fg-367961cd8d7e618c';
...
const gltf=await loader.loadAsync('../fairy-garden/doll.glb?v=fg-367961cd8d7e618c');pet=createTraveler(gltf.scene,true,{});sc.add(pet.root);if(pending)apply(pending);
