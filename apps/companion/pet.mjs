...
import {GLTFLoader} from '../fairy-garden/vendor/GLTFLoader.js?v=fg-7721f2e1c45a3b3d';
import {DRACOLoader} from '../fairy-garden/vendor/DRACOLoader.js?v=fg-7721f2e1c45a3b3d';
import {createTraveler,setFaceBase} from '../fairy-garden/traveler.mjs?v=fg-7721f2e1c45a3b3d';
import {lookForTa,mergeLook,dyesOf,outfitId,outfitColors,hairId,HAIR_MODES} from '../fairy-garden/wardrobe.mjs?v=fg-7721f2e1c45a3b3d';
...
const gltf=await loader.loadAsync('../fairy-garden/doll.glb?v=fg-7721f2e1c45a3b3d');pet=createTraveler(gltf.scene,true,{});sc.add(pet.root);if(pending)apply(pending);
