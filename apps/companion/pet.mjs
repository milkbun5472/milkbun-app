...
import {GLTFLoader} from '../fairy-garden/vendor/GLTFLoader.js?v=fg-aeb880fda881a770';
import {DRACOLoader} from '../fairy-garden/vendor/DRACOLoader.js?v=fg-aeb880fda881a770';
import {createTraveler,setFaceBase} from '../fairy-garden/traveler.mjs?v=fg-aeb880fda881a770';
import {lookForTa,mergeLook,dyesOf,outfitId,outfitColors,hairId,HAIR_MODES} from '../fairy-garden/wardrobe.mjs?v=fg-aeb880fda881a770';
...
const gltf=await loader.loadAsync('../fairy-garden/doll.glb?v=fg-aeb880fda881a770');pet=createTraveler(gltf.scene,true,{});sc.add(pet.root);if(pending)apply(pending);
