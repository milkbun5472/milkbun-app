...
import {GLTFLoader} from '../fairy-garden/vendor/GLTFLoader.js?v=fg-62c9f6e29466f4a7';
import {DRACOLoader} from '../fairy-garden/vendor/DRACOLoader.js?v=fg-62c9f6e29466f4a7';
import {createTraveler,setFaceBase} from '../fairy-garden/traveler.mjs?v=fg-62c9f6e29466f4a7';
import {lookForTa,mergeLook,dyesOf,outfitId,outfitColors,hairId,HAIR_MODES} from '../fairy-garden/wardrobe.mjs?v=fg-62c9f6e29466f4a7';
...
const gltf=await loader.loadAsync('../fairy-garden/doll.glb?v=fg-62c9f6e29466f4a7');pet=createTraveler(gltf.scene,true,{});sc.add(pet.root);if(pending)apply(pending);
