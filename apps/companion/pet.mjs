...
import {createTraveler,setFaceBase} from '../fairy-garden/traveler.mjs?v=fg-0067d556fe1d225e';
import {lookForTa,mergeLook,dyesOf,outfitId,outfitColors,hairId,HAIR_MODES} from '../fairy-garden/wardrobe.mjs?v=fg-0067d556fe1d225e';
...
const gltf=await loader.loadAsync('../fairy-garden/doll.glb?v=fg-0067d556fe1d225e');pet=createTraveler(gltf.scene,true,{});sc.add(pet.root);if(pending)apply(pending);
