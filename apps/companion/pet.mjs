...
import {GLTFLoader} from '../fairy-garden/vendor/GLTFLoader.js?v=fg-ab7dd012f17a4221';
import {DRACOLoader} from '../fairy-garden/vendor/DRACOLoader.js?v=fg-ab7dd012f17a4221';
import {createTraveler,setFaceBase} from '../fairy-garden/traveler.mjs?v=fg-ab7dd012f17a4221';
import {lookForTa,mergeLook,dyesOf,outfitId,outfitColors,hairId,HAIR_MODES} from '../fairy-garden/wardrobe.mjs?v=fg-ab7dd012f17a4221';
...
const gltf=await loader.loadAsync('../fairy-garden/doll.glb?v=fg-ab7dd012f17a4221');pet=createTraveler(gltf.scene,true,{});sc.add(pet.root);if(pending)apply(pending);
