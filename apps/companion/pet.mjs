...
import {createTraveler,setFaceBase} from '../fairy-garden/traveler.mjs?v=fg-203678530265f0fa';
import {lookForTa,mergeLook,dyesOf,outfitId,outfitColors,hairId,HAIR_MODES} from '../fairy-garden/wardrobe.mjs?v=fg-203678530265f0fa';
...
const gltf=await loader.loadAsync('../fairy-garden/doll.glb?v=fg-203678530265f0fa');pet=createTraveler(gltf.scene,true,{});sc.add(pet.root);if(pending)apply(pending);
