...
import {GLTFLoader} from '../fairy-garden/vendor/GLTFLoader.js?v=fg-19e1c3ec928cbad3';
import {DRACOLoader} from '../fairy-garden/vendor/DRACOLoader.js?v=fg-19e1c3ec928cbad3';
import {createTraveler,setFaceBase} from '../fairy-garden/traveler.mjs?v=fg-19e1c3ec928cbad3';
import {lookForTa,mergeLook,dyesOf,outfitId,outfitColors,hairId,HAIR_MODES} from '../fairy-garden/wardrobe.mjs?v=fg-19e1c3ec928cbad3';
...
const gltf=await loader.loadAsync('../fairy-garden/doll.glb?v=fg-19e1c3ec928cbad3');pet=createTraveler(gltf.scene,true,{});sc.add(pet.root);if(pending)apply(pending);
