...
import {GLTFLoader} from '../fairy-garden/vendor/GLTFLoader.js?v=fg-acbcc149e90eb9e6';
import {DRACOLoader} from '../fairy-garden/vendor/DRACOLoader.js?v=fg-acbcc149e90eb9e6';
import {createTraveler,setFaceBase} from '../fairy-garden/traveler.mjs?v=fg-acbcc149e90eb9e6';
import {lookForTa,mergeLook,dyesOf,outfitId,outfitColors,hairId,HAIR_MODES} from '../fairy-garden/wardrobe.mjs?v=fg-acbcc149e90eb9e6';
...
const gltf=await loader.loadAsync('../fairy-garden/doll.glb?v=fg-acbcc149e90eb9e6');pet=createTraveler(gltf.scene,true,{});sc.add(pet.root);if(pending)apply(pending);
